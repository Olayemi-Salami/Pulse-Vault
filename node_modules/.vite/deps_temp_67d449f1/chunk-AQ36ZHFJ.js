...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !(function(t3, e3) {
      ...
      "use strict";
      var t3 = 1e3, e3 = 6e4, n2 = 36e5, r2 = "millisecond", i3 = "second", s3 = "minute", u2 = "hour", a = "day", o2 = "week", c3 = "month", f6 = "quarter", h5 = "year", d2 = "date", l4 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y5 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M3 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t4) {
        var e4 = ["th", "st", "nd", "rd"], n3 = t4 % 100;
        return "[" + t4 + (e4[(n3 - 20) % 10] || e4[n3] || e4[0]) + "]";
      } }, m2 = function(t4, e4, n3) {
        var r3 = String(t4);
        return !r3 || r3.length >= e4 ? t4 : "" + Array(e4 + 1 - r3.length).join(n3) + t4;
      }, v = { s: m2, z: function(t4) {
        var e4 = -t4.utcOffset(), n3 = Math.abs(e4), r3 = Math.floor(n3 / 60), i4 = n3 % 60;
        return (e4 <= 0 ? "+" : "-") + m2(r3, 2, "0") + ":" + m2(i4, 2, "0");
      }, m: function t4(e4, n3) {
        if (e4.date() < n3.date()) return -t4(n3, e4);
        var r3 = 12 * (n3.year() - e4.year()) + (n3.month() - e4.month()), i4 = e4.clone().add(r3, c3), s4 = n3 - i4 < 0, u3 = e4.clone().add(r3 + (s4 ? -1 : 1), c3);
        return +(-(r3 + (n3 - i4) / (s4 ? i4 - u3 : u3 - i4)) || 0);
      }, a: function(t4) {
        return t4 < 0 ? Math.ceil(t4) || 0 : Math.floor(t4);
      }, p: function(t4) {
        return { M: c3, y: h5, w: o2, d: a, D: d2, h: u2, m: s3, s: i3, ms: r2, Q: f6 }[t4] || String(t4 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t4) {
        return void 0 === t4;
      } }, g = "en", D = {};
      D[g] = M3;
      ...
      b.l = w, b.i = S2, b.w = function(t4, e4) {
      ...
      var _ = (function() {
        ...
        return m3.parse = function(t4) {
          ...
          var n3 = this, r3 = !!b.u(e4) || e4, f7 = b.p(t4), l5 = function(t5, e5) {
            var i4 = b.w(n3.$u ? Date.UTC(n3.$y, e5, t5) : new Date(n3.$y, e5, t5), n3);
            return r3 ? i4 : i4.endOf(a);
          }, $2 = function(t5, e5) {
            return b.w(n3.toDate()[t5].apply(n3.toDate("s"), (r3 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e5)), n3);
          }, y6 = this.$W, M5 = this.$M, m4 = this.$D, v2 = "set" + (this.$u ? "UTC" : "");
          switch (f7) {
            case h5:
            ...
            case o2:
              var g2 = this.$locale().weekStart || 0, D2 = (y6 < g2 ? y6 + 7 : y6) - g2;
          ...
          var n3, o3 = b.p(t4), f7 = "set" + (this.$u ? "UTC" : ""), l5 = (n3 = {}, n3[a] = f7 + "Date", n3[d2] = f7 + "Date", n3[c3] = f7 + "Month", n3[h5] = f7 + "FullYear", n3[u2] = f7 + "Hours", n3[s3] = f7 + "Minutes", n3[i3] = f7 + "Seconds", n3[r2] = f7 + "Milliseconds", n3)[o3], $2 = o3 === a ? this.$D + (e4 - this.$W) : e4;
          if (o3 === c3 || o3 === h5) {
            var y6 = this.clone().set(d2, 1);
            y6.$d[l5]($2), y6.init(), this.$d = y6.set(d2, Math.min(this.$D, y6.daysInMonth())).$d;
          } else l5 && this.$d[l5]($2);
          ...
          var d3, l5 = this;
          r3 = Number(r3);
          var $2 = b.p(f7), y6 = function(t4) {
            var e4 = O2(l5);
            return b.w(e4.date(e4.date() + Math.round(t4 * r3)), l5);
          };
          if ($2 === c3) return this.set(c3, this.$M + r3);
          if ($2 === h5) return this.set(h5, this.$y + r3);
          if ($2 === a) return y6(1);
          if ($2 === o2) return y6(7);
          var M5 = (d3 = {}, d3[s3] = e3, d3[u2] = n2, d3[i3] = t3, d3)[$2] || 1, m4 = this.$d.getTime() + r3 * M5;
          return b.w(m4, this);
          ...
          var r3 = t4 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b.z(this), s4 = this.$H, u3 = this.$m, a2 = this.$M, o3 = n3.weekdays, c4 = n3.months, f7 = n3.meridiem, h6 = function(t5, n4, i5, s5) {
            return t5 && (t5[n4] || t5(e4, r3)) || i5[n4].slice(0, s5);
          }, d3 = function(t5) {
            return b.s(s4 % 12 || 12, t5, "0");
          }, $2 = f7 || function(t5, e5, n4) {
            var r4 = t5 < 12 ? "AM" : "PM";
            return n4 ? r4.toLowerCase() : r4;
          };
          return r3.replace(y5, (function(t5, r4) {
            return r4 || (function(t6) {
              switch (t6) {
                ...
                case "MM":
                  return b.s(a2 + 1, 2, "0");
                case "MMM":
                  return h6(n3.monthsShort, a2, c4, 3);
                case "MMMM":
                  return h6(c4, a2);
                case "D":
                  return e4.$D;
                ...
                case "d":
                  return String(e4.$W);
                case "dd":
                  return h6(n3.weekdaysMin, e4.$W, o3, 2);
                case "ddd":
                  return h6(n3.weekdaysShort, e4.$W, o3, 3);
                case "dddd":
                  return o3[e4.$W];
                case "H":
                  return String(s4);
          ...
          var $2, y6 = this, M5 = b.p(d3), m4 = O2(r3), v2 = (m4.utcOffset() - this.utcOffset()) * e3, g2 = this - m4, D2 = function() {
            return b.m(y6, m4);
          };
          switch (M5) {
            case h5:
          ...
          if (!t4) return this.$L;
          var n3 = this.clone(), r3 = w(t4, e4, true);
      ...
      return O2.prototype = k2, [["$ms", r2], ["$s", i3], ["$m", s3], ["$H", u2], ["$W", a], ["$M", c3], ["$y", h5], ["$D", d2]].forEach((function(t4) {
        k2[t4[1]] = function(e4) {
          return this.$g(e4, t4[0], t4[1]);
        };
      })), O2.extend = function(t4, e4) {
        return t4.$i || (t4(e4, _, O2), t4.$i = true), O2;
...
var require_en = __commonJS({
  "node_modules/dayjs/locale/en.js"(exports, module) {
    !(function(e3, n2) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = n2() : "function" == typeof define && define.amd ? define(n2) : (e3 = "undefined" != typeof globalThis ? globalThis : e3 || self).dayjs_locale_en = n2();
    })(exports, (function() {
      "use strict";
      return { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(e3) {
        var n2 = ["th", "st", "nd", "rd"], t3 = e3 % 100;
        return "[" + e3 + (n2[(t3 - 20) % 10] || n2[t3] || n2[0]) + "]";
      } };
    }));
  }
});
  ...
  "node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !(function(r2, e3) {
      ...
      return function(r2, e3, t3) {
        ...
        function i3(r3, e4, t4, o3) {
          return n2.fromToBase(r3, e4, t4, o3);
        }
        t3.en.relativeTime = o2, n2.fromToBase = function(e4, n3, i4, d3, u2) {
          for (var f6, a, s3, l4 = i4.$locale().relativeTime || o2, h5 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h5.length, c3 = 0; c3 < m2; c3 += 1) {
            var y5 = h5[c3];
            y5.d && (f6 = d3 ? t3(e4).diff(i4, y5.d, true) : i4.diff(e4, y5.d, true));
            var p = (r2.rounding || Math.round)(Math.abs(f6));
            if (s3 = f6 > 0, p <= y5.r || !y5.r) {
              p <= 1 && c3 > 0 && (y5 = h5[c3 - 1]);
              var v = l4[y5.l];
              u2 && (p = u2("" + p)), a = "string" == typeof v ? v.replace("%d", p) : v(p, n3, y5.l, s3);
              break;
            }
          }
          if (n3) return a;
          var M3 = s3 ? l4.future : l4.past;
          return "function" == typeof M3 ? M3(a) : M3.replace("%s", a);
        }, n2.to = function(r3, e4) {
          return i3(r3, e4, this, true);
        }, n2.from = function(r3, e4) {
          return i3(r3, e4, this);
        };
        var d2 = function(r3) {
...
var require_updateLocale = __commonJS({
  "node_modules/dayjs/plugin/updateLocale.js"(exports, module) {
    !(function(e3, n2) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = n2() : "function" == typeof define && define.amd ? define(n2) : (e3 = "undefined" != typeof globalThis ? globalThis : e3 || self).dayjs_plugin_updateLocale = n2();
    })(exports, (function() {
      "use strict";
      return function(e3, n2, t3) {
        t3.updateLocale = function(e4, n3) {
          var o2 = t3.Ls[e4];
          if (o2) return (n3 ? Object.keys(n3) : []).forEach((function(e5) {
            o2[e5] = n3[e5];
          })), o2;
        };
      };
...
function parse(x, n2) {
  ...
  if ((e3 = n2.indexOf(".")) > -1) n2 = n2.replace(".", "");
  ...
  if (i3 == nl) {
    ...
    x.e = e3 - i3 - 1;
    x.c = [];
    for (e3 = 0; i3 <= nl; ) x.c[e3++] = +n2.charAt(i3++);
  }
  return x;
}
...
function stringify(x, doExponential, isNonzero) {
  var e3 = x.e, s3 = x.c.join(""), n2 = s3.length;
  if (doExponential) {
    s3 = s3.charAt(0) + (n2 > 1 ? "." + s3.slice(1) : "") + (e3 < 0 ? "e" : "e+") + e3;
  } else if (e3 < 0) {
    for (; ++e3; ) s3 = "0" + s3;
    s3 = "0." + s3;
  } else if (e3 > 0) {
    if (++e3 > n2) {
      ...
      s3 = s3.slice(0, e3) + "." + s3.slice(e3);
    }
  } else if (n2 > 1) {
    s3 = s3.charAt(0) + "." + s3.slice(1);
  }
  return x.s < 0 && isNonzero ? "-" + s3 : s3;
}
P.abs = function() {
...
P.cmp = function(y5) {
  var isneg, x = this, xc2 = x.c, yc2 = (y5 = new x.constructor(y5)).c, i3 = x.s, j = y5.s, k2 = x.e, l4 = y5.e;
...
P.div = function(y5) {
  var x = this, Big2 = x.constructor, a = x.c, b = (y5 = new Big2(y5)).c, k2 = x.s == y5.s ? 1 : -1, dp = Big2.DP;
  ...
  var bl, bt2, n2, cmp, ri3, bz = b.slice(), ai2 = bl = b.length, al = a.length, r2 = a.slice(0, bl), rl = r2.length, q2 = y5, qc2 = q2.c = [], qi2 = 0, p = dp + (q2.e = x.e - y5.e) + 1;
  q2.s = k2;
  k2 = p < 0 ? 0 : p;
  bz.unshift(0);
  for (; rl++ < bl; ) r2.push(0);
...
P.minus = P.sub = function(y5) {
  var i3, j, t3, xlty, x = this, Big2 = x.constructor, a = x.s, b = (y5 = new Big2(y5)).s;
  if (a != b) {
    y5.s = -b;
    return x.plus(y5);
  }
  var xc2 = x.c.slice(), xe2 = x.e, yc2 = y5.c, ye2 = y5.e;
  if (!xc2[0] || !yc2[0]) {
    if (yc2[0]) {
      y5.s = -b;
    } else if (xc2[0]) {
...
P.mod = function(y5) {
  var ygtx, x = this, Big2 = x.constructor, a = x.s, b = (y5 = new Big2(y5)).s;
  if (!y5.c[0]) {
    throw Error(DIV_BY_ZERO);
  }
  x.s = y5.s = 1;
...
P.plus = P.add = function(y5) {
  var e3, k2, t3, x = this, Big2 = x.constructor;
  y5 = new Big2(y5);
  if (x.s != y5.s) {
    y5.s = -y5.s;
    return x.minus(y5);
  }
  var xe2 = x.e, xc2 = x.c, ye2 = y5.e, yc2 = y5.c;
  if (!xc2[0] || !yc2[0]) {
    if (!yc2[0]) {
      if (xc2[0]) {
        y5 = new Big2(x);
  ...
  e3 = yc2.length;
  for (k2 = 0; e3; xc2[e3] %= 10) k2 = (xc2[--e3] = xc2[e3] + yc2[e3] + k2) / 10 | 0;
  if (k2) {
    xc2.unshift(k2);
    ++ye2;
  }
...
P.pow = function(n2) {
  var x = this, one = new x.constructor("1"), y5 = one, isneg = n2 < 0;
  if (n2 !== ~~n2 || n2 < -MAX_POWER || n2 > MAX_POWER) {
    throw Error(INVALID + "exponent");
  }
  if (isneg) n2 = -n2;
  for (; ; ) {
    if (n2 & 1) y5 = y5.times(x);
    n2 >>= 1;
    if (!n2) break;
    x = x.times(x);
  }
...
P.sqrt = function() {
  var r2, c3, t3, x = this, Big2 = x.constructor, s3 = x.s, e3 = x.e, half = new Big2("0.5");
  if (!x.c[0]) return new Big2(x);
  if (s3 < 0) {
    throw Error(NAME + "No square root");
  }
  s3 = Math.sqrt(+stringify(x, true, true));
  if (s3 === 0 || s3 === 1 / 0) {
    c3 = x.c.join("");
    if (!(c3.length + e3 & 1)) c3 += "0";
    s3 = Math.sqrt(c3);
    e3 = ((e3 + 1) / 2 | 0) - (e3 < 0 || e3 & 1);
    r2 = new Big2((s3 == 1 / 0 ? "5e" : (s3 = s3.toExponential()).slice(0, s3.indexOf("e") + 1)) + e3);
  } else {
    r2 = new Big2(s3 + "");
  }
  e3 = r2.e + (Big2.DP += 4);
  do {
    t3 = r2;
    r2 = half.times(t3.plus(x.div(t3)));
  } while (t3.c.slice(0, e3).join("") !== r2.c.slice(0, e3).join(""));
  return round(r2, (Big2.DP -= 4) + r2.e + 1, Big2.RM);
};
P.times = P.mul = function(y5) {
  var c3, x = this, Big2 = x.constructor, xc2 = x.c, yc2 = (y5 = new Big2(y5)).c, a = xc2.length, b = yc2.length, i3 = x.e, j = y5.e;
  y5.s = x.s == y5.s ? 1 : -1;
  if (!xc2[0] || !yc2[0]) {
    y5.c = [y5.e = 0];
    return y5;
...
var proxyStateMap2 = /* @__PURE__ */ new WeakMap();
var refSet2 = /* @__PURE__ */ new WeakSet();
var buildProxyFunction2 = (objectIs = Object.is, newProxy = (target, handler) => new Proxy(target, handler), canProxy = (x) => isObject2(x) && !refSet2.has(x) && (Array.isArray(x) || !(Symbol.iterator in x)) && !(x instanceof WeakMap) && !(x instanceof WeakSet) && !(x instanceof Error) && !(x instanceof Number) && !(x instanceof Date) && !(x instanceof String) && !(x instanceof RegExp) && !(x instanceof ArrayBuffer), shouldTrapDefineProperty = (desc) => desc.configurable && desc.enumerable && desc.writable, defaultHandlePromise = (promise) => {
  switch (promise.status) {
    case "fulfilled":
      return promise.value;
    case "rejected":
...
var [defaultProxyFunction2] = buildProxyFunction2();
...
function Ce(t3) {
  ...
  Wt(t3.outputLen), Wt(t3.blockLen);
}
function Rt(t3, e3 = true) {
...
function Gn(t3, e3) {
  Xt(t3);
  const n2 = e3.outputLen;
  if (t3.length < n2) throw new Error("digestInto() expects output buffer of length at least " + n2);
}
var le = BigInt(2 ** 32 - 1);
var Wn = BigInt(32);
function Ti(t3, e3 = false) {
  return e3 ? { h: Number(t3 & le), l: Number(t3 >> Wn & le) } : { h: Number(t3 >> Wn & le) | 0, l: Number(t3 & le) | 0 };
}
function Ri(t3, e3 = false) {
  let n2 = new Uint32Array(t3.length), r2 = new Uint32Array(t3.length);
  for (let o2 = 0; o2 < t3.length; o2++) {
    const { h: i3, l: s3 } = Ti(t3[o2], e3);
    [n2[o2], r2[o2]] = [i3, s3];
  }
  return [n2, r2];
}
var _i = (t3, e3, n2) => t3 << n2 | e3 >>> 32 - n2;
var $i = (t3, e3, n2) => e3 << n2 | t3 >>> 32 - n2;
var Li = (t3, e3, n2) => e3 << n2 - 32 | t3 >>> 64 - n2;
var ji = (t3, e3, n2) => t3 << n2 - 32 | e3 >>> 64 - n2;
...
function Jn(t3) {
  for (let e3 = 0; e3 < t3.length; e3++) t3[e3] = Pi2(t3[e3]);
}
function ki(t3) {
...
function $t(t3) {
  return typeof t3 == "string" && (t3 = ki(t3)), Xt(t3), t3;
}
function Vi(...t3) {
  let e3 = 0;
  ...
  for (let r2 = 0, o2 = 0; r2 < t3.length; r2++) {
    const i3 = t3[r2];
...
function Qn(t3) {
  const e3 = (r2) => t3().update($t(r2)).digest(), n2 = t3();
  return e3.outputLen = n2.outputLen, e3.blockLen = n2.blockLen, e3.create = () => t3(), e3;
}
function Lt(t3 = 32) {
  if (_t && typeof _t.getRandomValues == "function") return _t.getRandomValues(new Uint8Array(t3));
  if (_t && typeof _t.randomBytes == "function") return _t.randomBytes(t3);
...
var qi = BigInt(256);
var Ki = BigInt(113);
for (let t3 = 0, e3 = Jt, n2 = 1, r2 = 0; t3 < 24; t3++) {
  [n2, r2] = [r2, (2 * n2 + 3 * r2) % 5], tr.push(2 * (5 * r2 + n2)), er.push((t3 + 1) * (t3 + 2) / 2 % 64);
  let o2 = Mi;
  for (let i3 = 0; i3 < 7; i3++) e3 = (e3 << Jt ^ (e3 >> Hi) * Ki) % qi, e3 & Di && (o2 ^= Jt << (Jt << BigInt(i3)) - Jt);
  nr.push(o2);
}
var [Fi, zi] = Ri(nr, true);
var rr = (t3, e3, n2) => n2 > 32 ? Li(t3, e3, n2) : _i(t3, e3, n2);
var or = (t3, e3, n2) => n2 > 32 ? ji(t3, e3, n2) : $i(t3, e3, n2);
function Zi(t3, e3 = 24) {
  const n2 = new Uint32Array(10);
  for (let r2 = 24 - e3; r2 < 24; r2++) {
    for (let s3 = 0; s3 < 10; s3++) n2[s3] = t3[s3] ^ t3[s3 + 10] ^ t3[s3 + 20] ^ t3[s3 + 30] ^ t3[s3 + 40];
    for (let s3 = 0; s3 < 10; s3 += 2) {
      const c3 = (s3 + 8) % 10, a = (s3 + 2) % 10, u2 = n2[a], l4 = n2[a + 1], f6 = rr(u2, l4, 1) ^ n2[c3], h5 = or(u2, l4, 1) ^ n2[c3 + 1];
      for (let y5 = 0; y5 < 50; y5 += 10) t3[s3 + y5] ^= f6, t3[s3 + y5 + 1] ^= h5;
    }
    let o2 = t3[2], i3 = t3[3];
    for (let s3 = 0; s3 < 24; s3++) {
      const c3 = er[s3], a = rr(o2, i3, c3), u2 = or(o2, i3, c3), l4 = tr[s3];
      o2 = t3[l4], i3 = t3[l4 + 1], t3[l4] = a, t3[l4 + 1] = u2;
    }
    for (let s3 = 0; s3 < 50; s3 += 10) {
      for (let c3 = 0; c3 < 10; c3++) n2[c3] = t3[s3 + c3];
      for (let c3 = 0; c3 < 10; c3++) t3[s3 + c3] ^= ~n2[(c3 + 2) % 10] & n2[(c3 + 4) % 10];
    }
    t3[0] ^= Fi[r2], t3[1] ^= zi[r2];
  }
  n2.fill(0);
}
var En = class _En extends ke {
  constructor(e3, n2, r2, o2 = false, i3 = 24) {
    if (super(), this.blockLen = e3, this.suffix = n2, this.outputLen = r2, this.enableXOF = o2, this.rounds = i3, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, Wt(r2), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
  ...
  update(e3) {
    ...
    const o2 = e3.length;
    for (let i3 = 0; i3 < o2; ) {
      const s3 = Math.min(n2 - this.pos, o2 - i3);
      for (let c3 = 0; c3 < s3; c3++) r2[this.pos++] ^= e3[i3++];
  ...
  finish() {
    ...
    this.finished = true;
    const { state: e3, suffix: n2, pos: r2, blockLen: o2 } = this;
    e3[r2] ^= n2, (n2 & 128) !== 0 && r2 === o2 - 1 && this.keccak(), e3[o2 - 1] ^= 128, this.keccak();
  }
  writeInto(e3) {
    Rt(this, false), Xt(e3), this.finish();
    const n2 = this.state, { blockLen: r2 } = this;
    for (let o2 = 0, i3 = e3.length; o2 < i3; ) {
      this.posOut >= r2 && this.keccak();
      const s3 = Math.min(r2 - this.posOut, i3 - o2);
      e3.set(n2.subarray(this.posOut, this.posOut + s3), o2), this.posOut += s3, o2 += s3;
    }
    return e3;
  }
  xofInto(e3) {
  ...
  xof(e3) {
    return Wt(e3), this.xofInto(new Uint8Array(e3));
  }
  digestInto(e3) {
    if (Gn(e3, this), this.finished) throw new Error("digest() was already called");
  ...
  _cloneInto(e3) {
    const { blockLen: n2, suffix: r2, outputLen: o2, rounds: i3, enableXOF: s3 } = this;
    return e3 || (e3 = new _En(n2, r2, o2, s3, i3)), e3.state32.set(this.state32), e3.pos = this.pos, e3.posOut = this.posOut, e3.finished = this.finished, e3.rounds = i3, e3.suffix = r2, e3.outputLen = o2, e3.enableXOF = s3, e3.destroyed = this.destroyed, e3;
  }
};
var Yi = (t3, e3, n2) => Qn(() => new En(e3, t3, n2));
...
function tt(t3, ...e3) {
  if (!Sr(t3)) throw new Error("Uint8Array expected");
  if (e3.length > 0 && !e3.includes(t3.length)) throw new Error("Uint8Array expected of length " + e3 + ", got length=" + t3.length);
}
function Or(t3, e3 = true) {
  if (t3.destroyed) throw new Error("Hash instance has been destroyed");
  if (e3 && t3.finished) throw new Error("Hash#digest() has already been called");
}
function ps(t3, e3) {
...
function bs(t3, e3) {
  ...
  let n2 = 0;
  for (let r2 = 0; r2 < t3.length; r2++) n2 |= t3[r2] ^ e3[r2];
  return n2 === 0;
}
var Es = (t3, e3) => {
  function n2(r2, ...o2) {
    if (tt(r2), t3.nonceLength !== void 0) {
      const l4 = o2[0];
      if (!l4) throw new Error("nonce / iv required");
      t3.varSizeNonce ? tt(l4) : tt(l4, t3.nonceLength);
    }
    const i3 = t3.tagLength;
    i3 && o2[1] !== void 0 && tt(o2[1]);
    const s3 = e3(r2, ...o2), c3 = (l4, f6) => {
      if (f6 !== void 0) {
    ...
    return { encrypt(l4, f6) {
      ...
      return a = true, tt(l4), c3(s3.encrypt.length, f6), s3.encrypt(l4, f6);
    }, decrypt(l4, f6) {
      if (tt(l4), i3 && l4.length < i3) throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
      return c3(s3.decrypt.length, f6), s3.decrypt(l4, f6);
    } };
  }
  return Object.assign(n2, t3), n2;
};
function Br(t3, e3, n2 = true) {
  if (e3 === void 0) return new Uint8Array(t3);
  if (e3.length !== t3) throw new Error("invalid output length, expected " + t3 + ", got: " + e3.length);
  if (n2 && !vs(e3)) throw new Error("invalid output, must be aligned");
  return e3;
}
function Ir(t3, e3, n2, r2) {
  if (typeof t3.setBigUint64 == "function") return t3.setBigUint64(e3, n2, r2);
  const o2 = BigInt(32), i3 = BigInt(4294967295), s3 = Number(n2 >> o2 & i3), c3 = Number(n2 & i3), a = r2 ? 4 : 0, u2 = r2 ? 0 : 4;
  t3.setUint32(e3 + a, s3, r2), t3.setUint32(e3 + u2, c3, r2);
}
function vs(t3) {
...
var Nr = (t3) => Uint8Array.from(t3.split("").map((e3) => e3.charCodeAt(0)));
...
function Is(t3, e3, n2, r2, o2, i3, s3, c3) {
  const a = o2.length, u2 = new Uint8Array(ge), l4 = mt(u2), f6 = Ye(o2) && Ye(i3), h5 = f6 ? mt(o2) : Tr, y5 = f6 ? mt(i3) : Tr;
  for (let E2 = 0; E2 < a; s3++) {
    if (t3(e3, n2, r2, l4, s3, c3), s3 >= Ur) throw new Error("arx: counter overflow");
    const p = Math.min(ge, a - E2);
    if (f6 && p === ge) {
      const d2 = E2 / 4;
      if (E2 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let v = 0, m2; v < Bs; v++) m2 = d2 + v, y5[m2] = h5[m2] ^ l4[v];
      E2 += ge;
      continue;
    }
...
function Ns(t3, e3) {
  const { allowShortKeys: n2, extendNonceFn: r2, counterLength: o2, counterRight: i3, rounds: s3 } = ws({ allowShortKeys: false, counterLength: 8, counterRight: false, rounds: 20 }, e3);
  if (typeof t3 != "function") throw new Error("core must be a function");
  return Fe(o2), Fe(s3), Ar(i3), Ar(n2), (c3, a, u2, l4, f6 = 0) => {
    tt(c3), tt(a), tt(u2);
    const h5 = u2.length;
    if (l4 === void 0 && (l4 = new Uint8Array(h5)), tt(l4), Fe(f6), f6 < 0 || f6 >= Ur) throw new Error("arx: counter overflow");
    if (l4.length < h5) throw new Error(`arx: output (${l4.length}) is shorter than data (${h5})`);
    const y5 = [];
    let E2 = c3.length, p, d2;
    if (E2 === 32) y5.push(p = Ze(c3)), d2 = As;
    else if (E2 === 16 && n2) p = new Uint8Array(32), p.set(c3), p.set(c3, 16), d2 = Os, y5.push(p);
    ...
    if (m2 !== 12) {
      ...
      N.set(a, i3 ? 0 : 12 - a.length), a = N, y5.push(a);
    }
    const O2 = mt(a);
    return Is(t3, d2, v, O2, u2, l4, f6, s3), jt(...y5), l4;
  };
}
var F = (t3, e3) => t3[e3++] & 255 | (t3[e3++] & 255) << 8;
var Us = class {
  constructor(e3) {
    this.blockLen = 16, this.outputLen = 16, this.buffer = new Uint8Array(16), this.r = new Uint16Array(10), this.h = new Uint16Array(10), this.pad = new Uint16Array(8), this.pos = 0, this.finished = false, e3 = ze(e3), tt(e3, 32);
    const n2 = F(e3, 0), r2 = F(e3, 2), o2 = F(e3, 4), i3 = F(e3, 6), s3 = F(e3, 8), c3 = F(e3, 10), a = F(e3, 12), u2 = F(e3, 14);
    this.r[0] = n2 & 8191, this.r[1] = (n2 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | i3 << 9) & 8191, this.r[4] = (i3 >>> 4 | s3 << 12) & 255, this.r[5] = s3 >>> 1 & 8190, this.r[6] = (s3 >>> 14 | c3 << 2) & 8191, this.r[7] = (c3 >>> 11 | a << 5) & 8065, this.r[8] = (a >>> 8 | u2 << 8) & 8191, this.r[9] = u2 >>> 5 & 127;
    for (let l4 = 0; l4 < 8; l4++) this.pad[l4] = F(e3, 16 + 2 * l4);
  }
  process(e3, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s3 } = this, c3 = s3[0], a = s3[1], u2 = s3[2], l4 = s3[3], f6 = s3[4], h5 = s3[5], y5 = s3[6], E2 = s3[7], p = s3[8], d2 = s3[9], v = F(e3, n2 + 0), m2 = F(e3, n2 + 2), O2 = F(e3, n2 + 4), N = F(e3, n2 + 6), $ = F(e3, n2 + 8), B3 = F(e3, n2 + 10), A2 = F(e3, n2 + 12), T = F(e3, n2 + 14);
    let S2 = i3[0] + (v & 8191), L = i3[1] + ((v >>> 13 | m2 << 3) & 8191), U4 = i3[2] + ((m2 >>> 10 | O2 << 6) & 8191), _ = i3[3] + ((O2 >>> 7 | N << 9) & 8191), j = i3[4] + ((N >>> 4 | $ << 12) & 8191), g = i3[5] + ($ >>> 1 & 8191), w = i3[6] + (($ >>> 14 | B3 << 2) & 8191), b = i3[7] + ((B3 >>> 11 | A2 << 5) & 8191), I2 = i3[8] + ((A2 >>> 8 | T << 8) & 8191), R3 = i3[9] + (T >>> 5 | o2), x = 0, C4 = x + S2 * c3 + L * (5 * d2) + U4 * (5 * p) + _ * (5 * E2) + j * (5 * y5);
    x = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h5) + w * (5 * f6) + b * (5 * l4) + I2 * (5 * u2) + R3 * (5 * a), x += C4 >>> 13, C4 &= 8191;
    let P4 = x + S2 * a + L * c3 + U4 * (5 * d2) + _ * (5 * p) + j * (5 * E2);
    x = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y5) + w * (5 * h5) + b * (5 * f6) + I2 * (5 * l4) + R3 * (5 * u2), x += P4 >>> 13, P4 &= 8191;
    let k2 = x + S2 * u2 + L * a + U4 * c3 + _ * (5 * d2) + j * (5 * p);
    x = k2 >>> 13, k2 &= 8191, k2 += g * (5 * E2) + w * (5 * y5) + b * (5 * h5) + I2 * (5 * f6) + R3 * (5 * l4), x += k2 >>> 13, k2 &= 8191;
    let M3 = x + S2 * l4 + L * u2 + U4 * a + _ * c3 + j * (5 * d2);
    x = M3 >>> 13, M3 &= 8191, M3 += g * (5 * p) + w * (5 * E2) + b * (5 * y5) + I2 * (5 * h5) + R3 * (5 * f6), x += M3 >>> 13, M3 &= 8191;
    let D = x + S2 * f6 + L * l4 + U4 * u2 + _ * a + j * c3;
    x = D >>> 13, D &= 8191, D += g * (5 * d2) + w * (5 * p) + b * (5 * E2) + I2 * (5 * y5) + R3 * (5 * h5), x += D >>> 13, D &= 8191;
    let z = x + S2 * h5 + L * f6 + U4 * l4 + _ * u2 + j * a;
    x = z >>> 13, z &= 8191, z += g * c3 + w * (5 * d2) + b * (5 * p) + I2 * (5 * E2) + R3 * (5 * y5), x += z >>> 13, z &= 8191;
    let Z2 = x + S2 * y5 + L * h5 + U4 * f6 + _ * l4 + j * u2;
    x = Z2 >>> 13, Z2 &= 8191, Z2 += g * a + w * c3 + b * (5 * d2) + I2 * (5 * p) + R3 * (5 * E2), x += Z2 >>> 13, Z2 &= 8191;
    let st2 = x + S2 * E2 + L * y5 + U4 * h5 + _ * f6 + j * l4;
    x = st2 >>> 13, st2 &= 8191, st2 += g * u2 + w * a + b * c3 + I2 * (5 * d2) + R3 * (5 * p), x += st2 >>> 13, st2 &= 8191;
    let W = x + S2 * p + L * E2 + U4 * y5 + _ * h5 + j * f6;
    x = W >>> 13, W &= 8191, W += g * l4 + w * u2 + b * a + I2 * c3 + R3 * (5 * d2), x += W >>> 13, W &= 8191;
    let J2 = x + S2 * d2 + L * p + U4 * E2 + _ * y5 + j * h5;
  ...
  finalize() {
    const { h: e3, pad: n2 } = this, r2 = new Uint16Array(10);
    let o2 = e3[1] >>> 13;
    e3[1] &= 8191;
    for (let c3 = 2; c3 < 10; c3++) e3[c3] += o2, o2 = e3[c3] >>> 13, e3[c3] &= 8191;
    e3[0] += o2 * 5, o2 = e3[0] >>> 13, e3[0] &= 8191, e3[1] += o2, o2 = e3[1] >>> 13, e3[1] &= 8191, e3[2] += o2, r2[0] = e3[0] + 5, o2 = r2[0] >>> 13, r2[0] &= 8191;
    for (let c3 = 1; c3 < 10; c3++) r2[c3] = e3[c3] + o2, o2 = r2[c3] >>> 13, r2[c3] &= 8191;
    r2[9] -= 8192;
    let i3 = (o2 ^ 1) - 1;
    for (let c3 = 0; c3 < 10; c3++) r2[c3] &= i3;
    i3 = ~i3;
    for (let c3 = 0; c3 < 10; c3++) e3[c3] = e3[c3] & i3 | r2[c3];
    ...
    let s3 = e3[0] + n2[0];
    e3[0] = s3 & 65535;
    for (let c3 = 1; c3 < 8; c3++) s3 = (e3[c3] + n2[c3] | 0) + (s3 >>> 16) | 0, e3[c3] = s3 & 65535;
    jt(r2);
  }
  update(e3) {
    Or(this);
    ...
    const o2 = e3.length;
    for (let i3 = 0; i3 < o2; ) {
      const s3 = Math.min(r2 - this.pos, o2 - i3);
      if (s3 === r2) {
        for (; r2 <= o2 - i3; i3 += r2) this.process(e3, i3);
        continue;
      }
      n2.set(e3.subarray(i3, i3 + s3), this.pos), this.pos += s3, i3 += s3, this.pos === r2 && (this.process(n2, 0, false), this.pos = 0);
    }
    return this;
  }
  destroy() {
  ...
  digestInto(e3) {
    Or(this), ps(e3, this), this.finished = true;
    ...
    this.finalize();
    let i3 = 0;
    for (let s3 = 0; s3 < 8; s3++) e3[i3++] = r2[s3] >>> 0, e3[i3++] = r2[s3] >>> 8;
    return e3;
  }
  digest() {
    const { buffer: e3, outputLen: n2 } = this;
    this.digestInto(e3);
    const r2 = e3.slice(0, n2);
    return this.destroy(), r2;
  }
};
function Ts(t3) {
  const e3 = (r2, o2) => t3(o2).update(ze(r2)).digest(), n2 = t3(new Uint8Array(32));
  return e3.outputLen = n2.outputLen, e3.blockLen = n2.blockLen, e3.create = (r2) => t3(r2), e3;
}
var Rs = Ts((t3) => new Us(t3));
function _s(t3, e3, n2, r2, o2, i3 = 20) {
  let s3 = t3[0], c3 = t3[1], a = t3[2], u2 = t3[3], l4 = e3[0], f6 = e3[1], h5 = e3[2], y5 = e3[3], E2 = e3[4], p = e3[5], d2 = e3[6], v = e3[7], m2 = o2, O2 = n2[0], N = n2[1], $ = n2[2], B3 = s3, A2 = c3, T = a, S2 = u2, L = l4, U4 = f6, _ = h5, j = y5, g = E2, w = p, b = d2, I2 = v, R3 = m2, x = O2, C4 = N, P4 = $;
  ...
  let k2 = 0;
  r2[k2++] = s3 + B3 | 0, r2[k2++] = c3 + A2 | 0, r2[k2++] = a + T | 0, r2[k2++] = u2 + S2 | 0, r2[k2++] = l4 + L | 0, r2[k2++] = f6 + U4 | 0, r2[k2++] = h5 + _ | 0, r2[k2++] = y5 + j | 0, r2[k2++] = E2 + g | 0, r2[k2++] = p + w | 0, r2[k2++] = d2 + b | 0, r2[k2++] = v + I2 | 0, r2[k2++] = m2 + R3 | 0, r2[k2++] = O2 + x | 0, r2[k2++] = N + C4 | 0, r2[k2++] = $ + P4 | 0;
}
var $s = Ns(_s, { counterRight: false, counterLength: 4, allowShortKeys: false });
var Ls = new Uint8Array(16);
var Rr = (t3, e3) => {
  t3.update(e3);
  const n2 = e3.length % 16;
  n2 && t3.update(Ls.subarray(n2));
};
var js = new Uint8Array(32);
function _r(t3, e3, n2, r2, o2) {
  const i3 = t3(e3, n2, js), s3 = Rs.create(i3);
  o2 && Rr(s3, o2), Rr(s3, r2);
  const c3 = new Uint8Array(16), a = gs(c3);
  Ir(a, 0, BigInt(o2 ? o2.length : 0), true), Ir(a, 8, BigInt(r2.length), true), s3.update(c3);
  const u2 = s3.digest();
  return jt(i3, c3), u2;
}
var Cs = (t3) => (e3, n2, r2) => ({ encrypt(i3, s3) {
  const c3 = i3.length;
  s3 = Br(c3 + 16, s3, false), s3.set(i3);
  const a = s3.subarray(0, -16);
  t3(e3, n2, a, a, 1);
  const u2 = _r(t3, e3, n2, a, r2);
  return s3.set(u2, c3), jt(u2), s3;
}, decrypt(i3, s3) {
  s3 = Br(i3.length - 16, s3, false);
  const c3 = i3.subarray(0, -16), a = i3.subarray(-16), u2 = _r(t3, e3, n2, c3, r2);
  if (!bs(a, u2)) throw new Error("invalid tag");
  return s3.set(i3.subarray(0, -16)), t3(e3, n2, s3, s3, 1), jt(u2), s3;
} });
var $r = Es({ blockSize: 64, nonceLength: 12, tagLength: 16 }, Cs($s));
var Lr = class extends ke {
  constructor(e3, n2) {
    super(), this.finished = false, this.destroyed = false, Ce(e3);
    const r2 = $t(n2);
    ...
    i3.set(r2.length > o2 ? e3.create().update(r2).digest() : r2);
    for (let s3 = 0; s3 < i3.length; s3++) i3[s3] ^= 54;
    this.iHash.update(i3), this.oHash = e3.create();
    for (let s3 = 0; s3 < i3.length; s3++) i3[s3] ^= 106;
    this.oHash.update(i3), i3.fill(0);
  }
  update(e3) {
    return Rt(this), this.iHash.update(e3), this;
  }
  digestInto(e3) {
    Rt(this), Xt(e3, this.outputLen), this.finished = true, this.iHash.digestInto(e3), this.oHash.update(e3), this.oHash.digestInto(e3), this.destroy();
  }
  digest() {
  ...
  _cloneInto(e3) {
    ...
    const { oHash: n2, iHash: r2, finished: o2, destroyed: i3, blockLen: s3, outputLen: c3 } = this;
    return e3 = e3, e3.finished = o2, e3.destroyed = i3, e3.blockLen = s3, e3.outputLen = c3, e3.oHash = n2._cloneInto(e3.oHash), e3.iHash = r2._cloneInto(e3.iHash), e3;
  }
  destroy() {
    this.destroyed = true, this.oHash.destroy(), this.iHash.destroy();
  }
};
var ye = (t3, e3, n2) => new Lr(t3, e3).update(n2).digest();
ye.create = (t3, e3) => new Lr(t3, e3);
var Ge = new Uint8Array([0]);
var jr = new Uint8Array();
function Ms(t3, e3, n2, r2) {
  if (typeof t3.setBigUint64 == "function") return t3.setBigUint64(e3, n2, r2);
  const o2 = BigInt(32), i3 = BigInt(4294967295), s3 = Number(n2 >> o2 & i3), c3 = Number(n2 & i3), a = r2 ? 4 : 0, u2 = r2 ? 0 : 4;
  t3.setUint32(e3 + a, s3, r2), t3.setUint32(e3 + u2, c3, r2);
}
function Ds(t3, e3, n2) {
  return t3 & e3 ^ ~t3 & n2;
}
function Hs(t3, e3, n2) {
  return t3 & e3 ^ t3 & n2 ^ e3 & n2;
}
var qs = class extends ke {
  constructor(e3, n2, r2, o2) {
    super(), this.blockLen = e3, this.outputLen = n2, this.padOffset = r2, this.isLE = o2, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e3), this.view = Pe(this.buffer);
  }
  update(e3) {
    Rt(this);
    ...
    const i3 = e3.length;
    for (let s3 = 0; s3 < i3; ) {
      const c3 = Math.min(o2 - this.pos, i3 - s3);
      if (c3 === o2) {
        const a = Pe(e3);
        for (; o2 <= i3 - s3; s3 += o2) this.process(a, s3);
        continue;
      }
      r2.set(e3.subarray(s3, s3 + c3), this.pos), this.pos += c3, s3 += c3, this.pos === o2 && (this.process(n2, 0), this.pos = 0);
    }
    return this.length += e3.length, this.roundClean(), this;
  }
  digestInto(e3) {
    Rt(this), Gn(e3, this), this.finished = true;
    const { buffer: n2, view: r2, blockLen: o2, isLE: i3 } = this;
    let { pos: s3 } = this;
    n2[s3++] = 128, this.buffer.subarray(s3).fill(0), this.padOffset > o2 - s3 && (this.process(r2, 0), s3 = 0);
    for (let f6 = s3; f6 < o2; f6++) n2[f6] = 0;
    Ms(r2, o2 - 8, BigInt(this.length * 8), i3), this.process(r2, 0);
    const c3 = Pe(e3), a = this.outputLen;
  ...
  _cloneInto(e3) {
    ...
    const { blockLen: n2, buffer: r2, length: o2, finished: i3, destroyed: s3, pos: c3 } = this;
    return e3.length = o2, e3.pos = c3, e3.finished = i3, e3.destroyed = s3, o2 % n2 && e3.buffer.set(r2), e3;
  }
};
...
var Fs = class extends qs {
  ...
  get() {
    const { A: e3, B: n2, C: r2, D: o2, E: i3, F: s3, G: c3, H: a } = this;
    return [e3, n2, r2, o2, i3, s3, c3, a];
  }
  set(e3, n2, r2, o2, i3, s3, c3, a) {
    this.A = e3 | 0, this.B = n2 | 0, this.C = r2 | 0, this.D = o2 | 0, this.E = i3 | 0, this.F = s3 | 0, this.G = c3 | 0, this.H = a | 0;
  }
  process(e3, n2) {
    for (let f6 = 0; f6 < 16; f6++, n2 += 4) bt[f6] = e3.getUint32(n2, false);
    for (let f6 = 16; f6 < 64; f6++) {
      const h5 = bt[f6 - 15], y5 = bt[f6 - 2], E2 = ct(h5, 7) ^ ct(h5, 18) ^ h5 >>> 3, p = ct(y5, 17) ^ ct(y5, 19) ^ y5 >>> 10;
      bt[f6] = p + bt[f6 - 7] + E2 + bt[f6 - 16] | 0;
    }
    let { A: r2, B: o2, C: i3, D: s3, E: c3, F: a, G: u2, H: l4 } = this;
    for (let f6 = 0; f6 < 64; f6++) {
      const h5 = ct(c3, 6) ^ ct(c3, 11) ^ ct(c3, 25), y5 = l4 + h5 + Ds(c3, a, u2) + Ks[f6] + bt[f6] | 0, p = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i3) | 0;
      l4 = u2, u2 = a, a = c3, c3 = s3 + y5 | 0, s3 = i3, i3 = o2, o2 = r2, r2 = y5 + p | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i3 = i3 + this.C | 0, s3 = s3 + this.D | 0, c3 = c3 + this.E | 0, a = a + this.F | 0, u2 = u2 + this.G | 0, l4 = l4 + this.H | 0, this.set(r2, o2, i3, s3, c3, a, u2, l4);
  }
  roundClean() {
    bt.fill(0);
  }
...
function te(t3) {
  if (!St(t3)) throw new Error("Uint8Array expected");
}
function Ct(t3, e3) {
  if (typeof e3 != "boolean") throw new Error(t3 + " boolean expected, got " + e3);
}
var Zs = Array.from({ length: 256 }, (t3, e3) => e3.toString(16).padStart(2, "0"));
function Pt(t3) {
  te(t3);
  let e3 = "";
  for (let n2 = 0; n2 < t3.length; n2++) e3 += Zs[t3[n2]];
  return e3;
}
function kt(t3) {
...
function We(t3) {
  ...
  return t3 === "" ? me : BigInt("0x" + t3);
}
var ut = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
function Cr(t3) {
  if (t3 >= ut._0 && t3 <= ut._9) return t3 - ut._0;
  if (t3 >= ut.A && t3 <= ut.F) return t3 - (ut.A - 10);
  if (t3 >= ut.a && t3 <= ut.f) return t3 - (ut.a - 10);
}
function Vt(t3) {
  if (typeof t3 != "string") throw new Error("hex string expected, got " + typeof t3);
  const e3 = t3.length, n2 = e3 / 2;
  if (e3 % 2) throw new Error("hex string expected, got unpadded hex of length " + e3);
  const r2 = new Uint8Array(n2);
  for (let o2 = 0, i3 = 0; o2 < n2; o2++, i3 += 2) {
    const s3 = Cr(t3.charCodeAt(i3)), c3 = Cr(t3.charCodeAt(i3 + 1));
    if (s3 === void 0 || c3 === void 0) {
      const a = t3[i3] + t3[i3 + 1];
...
function ee(t3) {
  return te(t3), We(Pt(Uint8Array.from(t3).reverse()));
}
function Mt(t3, e3) {
  return Vt(t3.toString(16).padStart(e3 * 2, "0"));
}
function be(t3, e3) {
  return Mt(t3, e3).reverse();
}
function Ys(t3) {
  return Vt(kt(t3));
}
function et(t3, e3, n2) {
  ...
  if (typeof e3 == "string") try {
    ...
    throw new Error(t3 + " must be hex string or Uint8Array, cause: " + i3);
  }
  else if (St(e3)) r2 = Uint8Array.from(e3);
  else throw new Error(t3 + " must be hex string or Uint8Array");
  const o2 = r2.length;
  if (typeof n2 == "number" && o2 !== n2) throw new Error(t3 + " of length " + n2 + " expected, got " + o2);
  return r2;
}
function ne(...t3) {
  let e3 = 0;
...
var Xe = (t3) => typeof t3 == "bigint" && me <= t3;
function Ee(t3, e3, n2) {
  return Xe(t3) && Xe(e3) && Xe(n2) && e3 <= t3 && t3 < n2;
}
function ft(t3, e3, n2, r2) {
  if (!Ee(e3, n2, r2)) throw new Error("expected valid " + t3 + ": " + n2 + " <= n < " + r2 + ", got " + e3);
}
function Pr(t3) {
  let e3;
  for (e3 = 0; t3 > me; t3 >>= we, e3 += 1) ;
  return e3;
}
function Xs(t3, e3) {
  return t3 >> BigInt(e3) & we;
}
function Js(t3, e3, n2) {
  return t3 | (n2 ? we : me) << BigInt(e3);
}
var Je = (t3) => (zs << BigInt(t3 - 1)) - we;
var Qe = (t3) => new Uint8Array(t3);
var kr = (t3) => Uint8Array.from(t3);
function Vr(t3, e3, n2) {
...
var Qs = { bigint: (t3) => typeof t3 == "bigint", function: (t3) => typeof t3 == "function", boolean: (t3) => typeof t3 == "boolean", string: (t3) => typeof t3 == "string", stringOrUint8Array: (t3) => typeof t3 == "string" || St(t3), isSafeInteger: (t3) => Number.isSafeInteger(t3), array: (t3) => Array.isArray(t3), field: (t3, e3) => e3.Fp.isValid(t3), hash: (t3) => typeof t3 == "function" && Number.isSafeInteger(t3.outputLen) };
function Dt(t3, e3, n2 = {}) {
  const r2 = (o2, i3, s3) => {
    const c3 = Qs[i3];
    if (typeof c3 != "function") throw new Error("invalid validator function");
    const a = t3[o2];
    if (!(s3 && a === void 0) && !c3(a, t3)) throw new Error("param " + String(o2) + " is invalid. Expected " + i3 + ", got " + a);
  };
  for (const [o2, i3] of Object.entries(e3)) r2(o2, i3, false);
...
function X(t3, e3) {
  const n2 = t3 % e3;
  return n2 >= q ? n2 : e3 + n2;
}
function Hr(t3, e3, n2) {
  if (e3 < q) throw new Error("invalid exponent, negatives unsupported");
  if (n2 <= q) throw new Error("invalid modulus");
  if (n2 === H) return q;
  let r2 = H;
  for (; e3 > q; ) e3 & H && (r2 = r2 * t3 % n2), t3 = t3 * t3 % n2, e3 >>= H;
  return r2;
}
function it(t3, e3, n2) {
  let r2 = t3;
  for (; e3-- > q; ) r2 *= r2, r2 %= n2;
  return r2;
}
function nn(t3, e3) {
  if (t3 === q) throw new Error("invert: expected non-zero number");
  if (e3 <= q) throw new Error("invert: expected positive modulus, got " + e3);
  let n2 = X(t3, e3), r2 = e3, o2 = q, i3 = H;
  for (; n2 !== q; ) {
...
function rc(t3) {
  const e3 = (t3 - H) / At;
  let n2, r2, o2;
  for (n2 = t3 - H, r2 = 0; n2 % At === q; n2 /= At, r2++) ;
  for (o2 = At; o2 < t3 && Hr(o2, e3, t3) !== t3 - H; o2++) if (o2 > 1e3) throw new Error("Cannot find square root: likely non-prime P");
  if (r2 === 1) {
    const s3 = (t3 + H) / en;
    return function(a, u2) {
      const l4 = a.pow(u2, s3);
  ...
  return function(c3, a) {
    if (c3.pow(a, e3) === c3.neg(c3.ONE)) throw new Error("Cannot find square root");
    let u2 = r2, l4 = c3.pow(c3.mul(c3.ONE, o2), n2), f6 = c3.pow(a, i3), h5 = c3.pow(a, n2);
    for (; !c3.eql(h5, c3.ONE); ) {
      if (c3.eql(h5, c3.ZERO)) return c3.ZERO;
      let y5 = 1;
      for (let p = c3.sqr(h5); y5 < u2 && !c3.eql(p, c3.ONE); y5++) p = c3.sqr(p);
      const E2 = c3.pow(l4, H << BigInt(u2 - y5 - 1));
      l4 = c3.sqr(E2), f6 = c3.mul(f6, E2), h5 = c3.mul(h5, l4), u2 = y5;
    }
    return f6;
  };
}
function oc(t3) {
  ...
  if (t3 % Dr === Mr) {
    const e3 = (t3 - Mr) / Dr;
    return function(r2, o2) {
      const i3 = r2.mul(o2, At), s3 = r2.pow(i3, e3), c3 = r2.mul(o2, s3), a = r2.mul(r2.mul(c3, At), s3), u2 = r2.mul(c3, r2.sub(a, r2.ONE));
...
function sc(t3) {
  const e3 = { ORDER: "bigint", MASK: "bigint", BYTES: "isSafeInteger", BITS: "isSafeInteger" }, n2 = ic.reduce((r2, o2) => (r2[o2] = "function", r2), e3);
  return Dt(t3, n2);
}
function cc(t3, e3, n2) {
  if (n2 < q) throw new Error("invalid exponent, negatives unsupported");
  if (n2 === q) return t3.ONE;
  if (n2 === H) return e3;
  let r2 = t3.ONE, o2 = e3;
  for (; n2 > q; ) n2 & H && (r2 = t3.mul(r2, o2)), o2 = t3.sqr(o2), n2 >>= H;
  return r2;
}
function ac(t3, e3) {
  const n2 = new Array(e3.length), r2 = e3.reduce((i3, s3, c3) => t3.is0(s3) ? i3 : (n2[c3] = i3, t3.mul(i3, s3)), t3.ONE), o2 = t3.inv(r2);
  return e3.reduceRight((i3, s3, c3) => t3.is0(s3) ? i3 : (n2[c3] = t3.mul(i3, n2[c3]), t3.mul(i3, s3)), o2), n2;
}
function qr(t3, e3) {
  const n2 = e3 !== void 0 ? e3 : t3.toString(2).length, r2 = Math.ceil(n2 / 8);
  return { nBitLength: n2, nByteLength: r2 };
}
function Kr2(t3, e3, n2 = false, r2 = {}) {
  if (t3 <= q) throw new Error("invalid field: expected ORDER > 0, got " + t3);
  const { nBitLength: o2, nByteLength: i3 } = qr(t3, e3);
  if (i3 > 2048) throw new Error("invalid field: expected ORDER of <= 2048 bytes");
  let s3;
  const c3 = Object.freeze({ ORDER: t3, isLE: n2, BITS: o2, BYTES: i3, MASK: Je(o2), ZERO: q, ONE: H, create: (a) => X(a, t3), isValid: (a) => {
    if (typeof a != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a);
    return q <= a && a < t3;
  }, is0: (a) => a === q, isOdd: (a) => (a & H) === H, neg: (a) => X(-a, t3), eql: (a, u2) => a === u2, sqr: (a) => X(a * a, t3), add: (a, u2) => X(a + u2, t3), sub: (a, u2) => X(a - u2, t3), mul: (a, u2) => X(a * u2, t3), pow: (a, u2) => cc(c3, a, u2), div: (a, u2) => X(a * nn(u2, t3), t3), sqrN: (a) => a * a, addN: (a, u2) => a + u2, subN: (a, u2) => a - u2, mulN: (a, u2) => a * u2, inv: (a) => nn(a, t3), sqrt: r2.sqrt || ((a) => (s3 || (s3 = oc(t3)), s3(c3, a))), invertBatch: (a) => ac(c3, a), cmov: (a, u2, l4) => l4 ? u2 : a, toBytes: (a) => n2 ? be(a, i3) : Mt(a, i3), fromBytes: (a) => {
...
function uc(t3, e3, n2 = false) {
  const r2 = t3.length, o2 = Fr(e3), i3 = zr(e3);
  if (r2 < 16 || r2 < i3 || r2 > 1024) throw new Error("expected " + i3 + "-1024 bytes of input, got " + r2);
  const s3 = n2 ? ee(t3) : Ot(t3), c3 = X(s3, e3 - H) + H;
...
function on(t3, e3) {
  Yr(t3, e3);
  const n2 = Math.ceil(e3 / t3) + 1, r2 = 2 ** (t3 - 1);
  return { windows: n2, windowSize: r2 };
}
function fc(t3, e3) {
  if (!Array.isArray(t3)) throw new Error("array expected");
  t3.forEach((n2, r2) => {
    if (!(n2 instanceof e3)) throw new Error("invalid point at index " + r2);
  });
}
function lc(t3, e3) {
  if (!Array.isArray(t3)) throw new Error("array of scalars expected");
  t3.forEach((n2, r2) => {
    if (!e3.isValid(n2)) throw new Error("invalid scalar at index " + r2);
  });
}
...
function dc(t3, e3) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    return cn(n2) !== 1;
  }, unsafeLadder(n2, r2, o2 = t3.ZERO) {
    let i3 = n2;
    for (; r2 > Zr; ) r2 & ve && (o2 = o2.add(i3)), i3 = i3.double(), r2 >>= ve;
    return o2;
  }, precomputeWindow(n2, r2) {
    const { windows: o2, windowSize: i3 } = on(r2, e3), s3 = [];
    let c3 = n2, a = c3;
    for (let u2 = 0; u2 < o2; u2++) {
      a = c3, s3.push(a);
      for (let l4 = 1; l4 < i3; l4++) a = a.add(c3), s3.push(a);
      c3 = a.double();
    }
    return s3;
  }, wNAF(n2, r2, o2) {
    const { windows: i3, windowSize: s3 } = on(n2, e3);
    let c3 = t3.ZERO, a = t3.BASE;
    const u2 = BigInt(2 ** n2 - 1), l4 = 2 ** n2, f6 = BigInt(n2);
    for (let h5 = 0; h5 < i3; h5++) {
      const y5 = h5 * s3;
      let E2 = Number(o2 & u2);
      o2 >>= f6, E2 > s3 && (E2 -= l4, o2 += ve);
      const p = y5, d2 = y5 + Math.abs(E2) - 1, v = h5 % 2 !== 0, m2 = E2 < 0;
      E2 === 0 ? a = a.add(rn(v, r2[p])) : c3 = c3.add(rn(m2, r2[d2]));
    }
    return { p: c3, f: a };
  }, wNAFUnsafe(n2, r2, o2, i3 = t3.ZERO) {
    const { windows: s3, windowSize: c3 } = on(n2, e3), a = BigInt(2 ** n2 - 1), u2 = 2 ** n2, l4 = BigInt(n2);
    for (let f6 = 0; f6 < s3; f6++) {
      const h5 = f6 * c3;
      if (o2 === Zr) break;
      let y5 = Number(o2 & a);
      if (o2 >>= l4, y5 > c3 && (y5 -= u2, o2 += ve), y5 === 0) continue;
      let E2 = r2[h5 + Math.abs(y5) - 1];
      y5 < 0 && (E2 = E2.negate()), i3 = i3.add(E2);
    }
    return i3;
    ...
    const s3 = cn(n2);
    return s3 === 1 ? this.unsafeLadder(n2, r2, i3) : this.wNAFUnsafe(s3, this.getPrecomputes(s3, n2, o2), r2, i3);
  }, setWindowSize(n2, r2) {
    Yr(r2, e3), Gr.set(n2, r2), sn2.delete(n2);
  } };
}
function hc(t3, e3, n2, r2) {
  if (fc(n2, t3), lc(r2, e3), n2.length !== r2.length) throw new Error("arrays of points and scalars must have equal length");
  const o2 = t3.ZERO, i3 = Pr(BigInt(n2.length)), s3 = i3 > 12 ? i3 - 3 : i3 > 4 ? i3 - 2 : i3 ? 2 : 1, c3 = (1 << s3) - 1, a = new Array(c3 + 1).fill(o2), u2 = Math.floor((e3.BITS - 1) / s3) * s3;
  let l4 = o2;
  for (let f6 = u2; f6 >= 0; f6 -= s3) {
    a.fill(o2);
    for (let y5 = 0; y5 < r2.length; y5++) {
      const E2 = r2[y5], p = Number(E2 >> BigInt(f6) & BigInt(c3));
      a[p] = a[p].add(n2[y5]);
    }
    let h5 = o2;
    for (let y5 = a.length - 1, E2 = o2; y5 > 0; y5--) E2 = E2.add(a[y5]), h5 = h5.add(E2);
    if (l4 = l4.add(h5), f6 !== 0) for (let y5 = 0; y5 < s3; y5++) l4 = l4.double();
  }
  return l4;
}
function Wr(t3) {
  return sc(t3.Fp), Dt(t3, { n: "bigint", h: "bigint", Gx: "field", Gy: "field" }, { nBitLength: "isSafeInteger", nByteLength: "isSafeInteger" }), Object.freeze({ ...qr(t3.n, t3.nBitLength), ...t3, p: t3.Fp.ORDER });
}
BigInt(0), BigInt(1), BigInt(2), BigInt(8);
var Ht = BigInt(0);
var an = BigInt(1);
function pc(t3) {
  return Dt(t3, { a: "bigint" }, { montgomeryBits: "isSafeInteger", nByteLength: "isSafeInteger", adjustScalarBytes: "function", domain: "function", powPminus2: "function", Gu: "bigint" }), Object.freeze({ ...t3 });
}
function gc(t3) {
  const e3 = pc(t3), { P: n2 } = e3, r2 = (m2) => X(m2, n2), o2 = e3.montgomeryBits, i3 = Math.ceil(o2 / 8), s3 = e3.nByteLength, c3 = e3.adjustScalarBytes || ((m2) => m2), a = e3.powPminus2 || ((m2) => Hr(m2, n2 - BigInt(2), n2));
  function u2(m2, O2, N) {
    const $ = r2(m2 * (O2 - N));
    return O2 = r2(O2 - $), N = r2(N + $), [O2, N];
  }
  const l4 = (e3.a - BigInt(2)) / BigInt(4);
  function f6(m2, O2) {
  ...
  return { scalarMult: p, scalarMultBase: v, getSharedSecret: (m2, O2) => p(m2, O2), getPublicKey: (m2) => v(m2), utils: { randomPrivateKey: () => e3.randomBytes(e3.nByteLength) }, GuBytes: d2 };
}
...
BigInt(8);
function bc(t3) {
  const e3 = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un, c3 = t3 * t3 % i3 * t3 % i3, a = it(c3, Xr, i3) * c3 % i3, u2 = it(a, yc, i3) * t3 % i3, l4 = it(u2, wc, i3) * u2 % i3, f6 = it(l4, e3, i3) * l4 % i3, h5 = it(f6, n2, i3) * f6 % i3, y5 = it(h5, r2, i3) * h5 % i3, E2 = it(y5, o2, i3) * y5 % i3, p = it(E2, o2, i3) * y5 % i3, d2 = it(p, e3, i3) * l4 % i3;
  return { pow_p_5_8: it(d2, Xr, i3) * t3 % i3, b2: c3 };
}
function Ec(t3) {
  return t3[0] &= 248, t3[31] &= 127, t3[31] |= 64, t3;
}
var fn = gc({ P: un, a: BigInt(486662), montgomeryBits: 255, nByteLength: 32, Gu: BigInt(9), powPminus2: (t3) => {
  const e3 = un, { pow_p_5_8: n2, b2: r2 } = bc(t3);
  return X(it(n2, mc, e3) * r2, e3);
}, adjustScalarBytes: Ec, randomBytes: Lt });
function Jr(t3) {
  t3.lowS !== void 0 && Ct("lowS", t3.lowS), t3.prehash !== void 0 && Ct("prehash", t3.prehash);
}
function vc(t3) {
  const e3 = Wr(t3);
  Dt(e3, { a: "field", b: "field" }, { allowedPrivateKeyLengths: "array", wrapPrivateKey: "boolean", isTorsionFree: "function", clearCofactor: "function", allowInfinityPoint: "boolean", fromBytes: "function", toBytes: "function" });
  const { endo: n2, Fp: r2, a: o2 } = e3;
  if (n2) {
...
var lt = { Err: Oc, _tlv: { encode: (t3, e3) => {
  const { Err: n2 } = lt;
  if (t3 < 0 || t3 > 256) throw new n2("tlv.encode: wrong tag");
  if (e3.length & 1) throw new n2("tlv.encode: unpadded data");
  const r2 = e3.length / 2, o2 = kt(r2);
  if (o2.length / 2 & 128) throw new n2("tlv.encode: long form length too big");
  const i3 = r2 > 127 ? kt(o2.length / 2 | 128) : "";
  return kt(t3) + i3 + o2 + e3;
}, decode(t3, e3) {
  const { Err: n2 } = lt;
  let r2 = 0;
  if (t3 < 0 || t3 > 256) throw new n2("tlv.encode: wrong tag");
  if (e3.length < 2 || e3[r2++] !== t3) throw new n2("tlv.decode: wrong tlv");
  const o2 = e3[r2++], i3 = !!(o2 & 128);
  let s3 = 0;
  if (!i3) s3 = o2;
  else {
    const a = o2 & 127;
    ...
    for (const l4 of u2) s3 = s3 << 8 | l4;
    if (r2 += a, s3 < 128) throw new n2("tlv.decode(long): not minimal encoding");
  }
  const c3 = e3.subarray(r2, r2 + s3);
  if (c3.length !== s3) throw new n2("tlv.decode: wrong value length");
  return { v: c3, l: e3.subarray(r2 + s3) };
} }, _int: { encode(t3) {
  const { Err: e3 } = lt;
  if (t3 < dt) throw new e3("integer: negative integers are not allowed");
  let n2 = kt(t3);
  if (Number.parseInt(n2[0], 16) & 8 && (n2 = "00" + n2), n2.length & 1) throw new e3("unexpected DER parsing assertion: unpadded hex");
  return n2;
}, decode(t3) {
  const { Err: e3 } = lt;
  ...
  const { Err: e3, _int: n2, _tlv: r2 } = lt, o2 = typeof t3 == "string" ? Sc(t3) : t3;
  te(o2);
  const { v: i3, l: s3 } = r2.decode(48, o2);
  if (s3.length) throw new e3("invalid signature: left bytes after parsing");
  const { v: c3, l: a } = r2.decode(2, i3), { v: u2, l: l4 } = r2.decode(2, a);
  if (l4.length) throw new e3("invalid signature: left bytes after parsing");
  return { r: n2.decode(c3), s: n2.decode(u2) };
}, hexFromSig(t3) {
  const { _tlv: e3, _int: n2 } = lt, r2 = e3.encode(2, n2.encode(t3.r)), o2 = e3.encode(2, n2.encode(t3.s)), i3 = r2 + o2;
  return e3.encode(48, i3);
} };
var dt = BigInt(0);
var K = BigInt(1);
BigInt(2);
...
BigInt(4);
function Ac(t3) {
  const e3 = vc(t3), { Fp: n2 } = e3, r2 = Kr2(e3.n, e3.nBitLength), o2 = e3.toBytes || ((p, d2, v) => {
  ...
  function s3(p) {
    const { a: d2, b: v } = e3, m2 = n2.sqr(p), O2 = n2.mul(m2, p);
    return n2.add(n2.add(O2, n2.mul(p, d2)), v);
  }
  if (!n2.eql(n2.sqr(e3.Gy), s3(e3.Gx))) throw new Error("bad generator point: equation left != right");
  function c3(p) {
    return Ee(p, K, e3.n);
  }
  function a(p) {
    const { allowedPrivateKeyLengths: d2, nByteLength: v, wrapPrivateKey: m2, n: O2 } = e3;
  ...
  function u2(p) {
    if (!(p instanceof h5)) throw new Error("ProjectivePoint expected");
  }
  const l4 = tn((p, d2) => {
  ...
  class h5 {
    ...
    static fromAffine(d2) {
      ...
      if (d2 instanceof h5) throw new Error("projective point not allowed");
      const O2 = (N) => n2.eql(N, n2.ZERO);
      return O2(v) && O2(m2) ? h5.ZERO : new h5(v, m2, n2.ONE);
    }
    get x() {
    ...
    static normalizeZ(d2) {
      ...
      return d2.map((m2, O2) => m2.toAffine(v[O2])).map(h5.fromAffine);
    }
    static fromHex(d2) {
      const v = h5.fromAffine(i3(et("pointHex", d2)));
      return v.assertValidity(), v;
    }
    static fromPrivateKey(d2) {
      return h5.BASE.multiply(a(d2));
    }
    static msm(d2, v) {
      return hc(h5, r2, d2, v);
    }
    _setWindowSize(d2) {
    ...
    double() {
      const { a: d2, b: v } = e3, m2 = n2.mul(v, Qr), { px: O2, py: N, pz: $ } = this;
      let B3 = n2.ZERO, A2 = n2.ZERO, T = n2.ZERO, S2 = n2.mul(O2, O2), L = n2.mul(N, N), U4 = n2.mul($, $), _ = n2.mul(O2, N);
      return _ = n2.add(_, _), T = n2.mul(O2, $), T = n2.add(T, T), B3 = n2.mul(d2, T), A2 = n2.mul(m2, U4), A2 = n2.add(B3, A2), B3 = n2.sub(L, A2), A2 = n2.add(L, A2), A2 = n2.mul(B3, A2), B3 = n2.mul(_, B3), T = n2.mul(m2, T), U4 = n2.mul(d2, U4), _ = n2.sub(S2, U4), _ = n2.mul(d2, _), _ = n2.add(_, T), T = n2.add(S2, S2), S2 = n2.add(T, S2), S2 = n2.add(S2, U4), S2 = n2.mul(S2, _), A2 = n2.add(A2, S2), U4 = n2.mul(N, $), U4 = n2.add(U4, U4), S2 = n2.mul(U4, _), B3 = n2.sub(B3, S2), T = n2.mul(U4, L), T = n2.add(T, T), T = n2.add(T, T), new h5(B3, A2, T);
    }
    add(d2) {
      u2(d2);
      const { px: v, py: m2, pz: O2 } = this, { px: N, py: $, pz: B3 } = d2;
      let A2 = n2.ZERO, T = n2.ZERO, S2 = n2.ZERO;
      const L = e3.a, U4 = n2.mul(e3.b, Qr);
      let _ = n2.mul(v, N), j = n2.mul(m2, $), g = n2.mul(O2, B3), w = n2.add(v, m2), b = n2.add(N, $);
      w = n2.mul(w, b), b = n2.add(_, j), w = n2.sub(w, b), b = n2.add(v, O2);
      let I2 = n2.add(N, B3);
      return b = n2.mul(b, I2), I2 = n2.add(_, g), b = n2.sub(b, I2), I2 = n2.add(m2, O2), A2 = n2.add($, B3), I2 = n2.mul(I2, A2), A2 = n2.add(j, g), I2 = n2.sub(I2, A2), S2 = n2.mul(L, b), A2 = n2.mul(U4, g), S2 = n2.add(A2, S2), A2 = n2.sub(j, S2), S2 = n2.add(j, S2), T = n2.mul(A2, S2), j = n2.add(_, _), j = n2.add(j, _), g = n2.mul(L, g), b = n2.mul(U4, b), j = n2.add(j, g), g = n2.sub(_, g), g = n2.mul(L, g), b = n2.add(b, g), _ = n2.mul(j, b), T = n2.add(T, _), _ = n2.mul(I2, b), A2 = n2.mul(w, A2), A2 = n2.sub(A2, _), _ = n2.mul(w, j), S2 = n2.mul(I2, S2), S2 = n2.add(S2, _), new h5(A2, T, S2);
    }
    subtract(d2) {
    ...
    wNAF(d2) {
      return E2.wNAFCached(this, d2, h5.normalizeZ);
    }
    multiplyUnsafe(d2) {
      const { endo: v, n: m2 } = e3;
      ft("scalar", d2, dt, m2);
      const O2 = h5.ZERO;
      if (d2 === dt) return O2;
      if (this.is0() || d2 === K) return this;
      if (!v || E2.hasPrecomputes(this)) return E2.wNAFCachedUnsafe(this, d2, h5.normalizeZ);
      ...
      return N && (T = T.negate()), B3 && (S2 = S2.negate()), S2 = new h5(n2.mul(S2.px, v.beta), S2.py, S2.pz), T.add(S2);
    }
    multiply(d2) {
      const { endo: v, n: m2 } = e3;
      ft("scalar", d2, K, m2);
      ...
      if (v) {
        ...
        S2 = E2.constTimeNegate($, S2), U4 = E2.constTimeNegate(A2, U4), U4 = new h5(n2.mul(U4.px, v.beta), U4.py, U4.pz), O2 = S2.add(U4), N = L.add(_);
      } else {
        const { p: $, f: B3 } = this.wNAF(d2);
        O2 = $, N = B3;
      }
      return h5.normalizeZ([O2, N])[0];
    }
    multiplyAndAddUnsafe(d2, v, m2) {
      const O2 = h5.BASE, N = (B3, A2) => A2 === dt || A2 === K || !B3.equals(O2) ? B3.multiplyUnsafe(A2) : B3.multiply(A2), $ = N(this, v).add(N(d2, m2));
      return $.is0() ? void 0 : $;
    }
    toAffine(d2) {
      return l4(this, d2);
    ...
    isTorsionFree() {
      const { h: d2, isTorsionFree: v } = e3;
      if (d2 === K) return true;
      if (v) return v(h5, this);
      throw new Error("isTorsionFree() has not been declared for the elliptic curve");
    }
    clearCofactor() {
      const { h: d2, clearCofactor: v } = e3;
      return d2 === K ? this : v ? v(h5, this) : this.multiplyUnsafe(e3.h);
    }
    toRawBytes(d2 = true) {
      return Ct("isCompressed", d2), this.assertValidity(), o2(h5, this, d2);
    }
    toHex(d2 = true) {
      return Ct("isCompressed", d2), Pt(this.toRawBytes(d2));
    }
  }
  h5.BASE = new h5(e3.Gx, e3.Gy, n2.ONE), h5.ZERO = new h5(n2.ZERO, n2.ONE, n2.ZERO);
  const y5 = e3.nBitLength, E2 = dc(h5, e3.endo ? Math.ceil(y5 / 2) : y5);
  return { CURVE: e3, ProjectivePoint: h5, normPrivateKeyToScalar: a, weierstrassEquation: s3, isWithinCurveOrder: c3 };
}
function Bc(t3) {
  const e3 = Wr(t3);
  return Dt(e3, { hash: "hash", hmac: "function", randomBytes: "function" }, { bits2int: "function", bits2int_modN: "function", lowS: "boolean" }), Object.freeze({ lowS: true, ...e3 });
}
function Ic(t3) {
  const e3 = Bc(t3), { Fp: n2, n: r2 } = e3, o2 = n2.BYTES + 1, i3 = 2 * n2.BYTES + 1;
  function s3(g) {
    return X(g, r2);
  }
  function c3(g) {
  ...
  const { ProjectivePoint: a, normPrivateKeyToScalar: u2, weierstrassEquation: l4, isWithinCurveOrder: f6 } = Ac({ ...e3, toBytes(g, w, b) {
  ...
  class d2 {
    ...
    recoverPublicKey(w) {
      ...
      const C4 = R3 === 2 || R3 === 3 ? b + e3.n : b;
      if (C4 >= n2.ORDER) throw new Error("recovery id 2 or 3 invalid");
      const P4 = (R3 & 1) === 0 ? "02" : "03", k2 = a.fromHex(P4 + h5(C4)), M3 = c3(C4), D = s3(-x * M3), z = s3(I2 * M3), Z2 = a.BASE.multiplyAndAddUnsafe(k2, D, z);
    ...
    normalizeS() {
      return this.hasHighS() ? new d2(this.r, s3(-this.s), this.recovery) : this;
    }
    toDERRawBytes() {
  ...
  const v = { isValidPrivateKey(g) {
    ...
    const g = zr(e3.n);
    return uc(e3.randomBytes(g), e3.n);
  ...
  const $ = e3.bits2int || function(g) {
    if (g.length > 8192) throw new Error("input is too large");
    const w = Ot(g), b = g.length * 8 - e3.nBitLength;
    return b > 0 ? w >> BigInt(b) : w;
  }, B3 = e3.bits2int_modN || function(g) {
    return s3($(g));
  }, A2 = Je(e3.nBitLength);
  function T(g) {
    return ft("num < 2^" + e3.nBitLength, g, dt, A2), Mt(g, e3.nByteLength);
  }
  function S2(g, w, b = L) {
    if (["recovered", "canonical"].some((W) => W in b)) throw new Error("sign() legacy options not supported");
    const { hash: I2, randomBytes: R3 } = e3;
    ...
    function st2(W) {
      const J2 = $(W);
      if (!f6(J2)) return;
      const Be3 = c3(J2), zt = a.BASE.multiply(J2).toAffine(), vt = s3(zt.x);
      if (vt === dt) return;
      const Zt = s3(Be3 * s3(Z2 + vt * M3));
      if (Zt === dt) return;
      let Ut = (zt.x === vt ? 0 : 2) | Number(zt.y & K), vn2 = Zt;
      return x && y5(Zt) && (vn2 = E2(Zt), Ut ^= 1), new d2(vt, vn2, Ut);
    }
    return { seed: z, k2sig: st2 };
  }
  const L = { lowS: e3.lowS, prehash: false }, U4 = { lowS: e3.lowS, prehash: false };
  function _(g, w, b = L) {
    const { seed: I2, k2sig: R3 } = S2(g, w, b), x = e3;
  ...
  function j(g, w, b, I2 = U4) {
    ...
    C4 && (w = e3.hash(w));
    const { r: Z2, s: st2 } = D, W = B3(w), J2 = c3(st2), Be3 = s3(W * J2), zt = s3(Z2 * J2), vt = a.BASE.multiplyAndAddUnsafe(z, Be3, zt)?.toAffine();
    return vt ? s3(vt.x) === Z2 : false;
  }
  return { CURVE: e3, getPublicKey: m2, getSharedSecret: N, sign: _, verify: j, ProjectivePoint: a, Signature: d2, utils: v };
}
function Nc(t3) {
  return { hash: t3, hmac: (e3, ...n2) => ye(t3, e3, Vi(...n2)), randomBytes: Lt };
}
function Uc(t3, e3) {
  const n2 = (r2) => Ic({ ...t3, ...Nc(r2) });
  return { ...n2(e3), create: n2 };
}
...
function rr2(r2, e3) {
  ...
  for (var t3 = new Uint8Array(256), i3 = 0; i3 < t3.length; i3++) t3[i3] = 255;
  for (var s3 = 0; s3 < r2.length; s3++) {
    var n2 = r2.charAt(s3), o2 = n2.charCodeAt(0);
    if (t3[o2] !== 255) throw new TypeError(n2 + " is ambiguous");
    t3[o2] = s3;
  }
  var a = r2.length, c3 = r2.charAt(0), h5 = Math.log(a) / Math.log(256), l4 = Math.log(256) / Math.log(a);
  function d2(u2) {
  ...
  function g(u2) {
    ...
    if (u2[b] !== " ") {
      ...
      for (var D = (u2.length - b) * h5 + 1 >>> 0, j = new Uint8Array(D); u2[b]; ) {
        var T = t3[u2.charCodeAt(b)];
        if (T === 255) return;
...
var hr = class {
  constructor(e3, t3, i3) {
    this.name = e3, this.prefix = t3, this.baseEncode = i3;
  }
  encode(e3) {
...
var lr = class {
  constructor(e3, t3, i3) {
    ...
    this.prefixCodePoint = t3.codePointAt(0), this.baseDecode = i3;
  }
  decode(e3) {
    if (typeof e3 == "string") {
...
var ur = class {
  ...
  decode(e3) {
    const t3 = e3[0], i3 = this.decoders[t3];
    if (i3) return i3.decode(e3);
...
var ri2 = (r2, e3) => new ur({ ...r2.decoders || { [r2.prefix]: r2 }, ...e3.decoders || { [e3.prefix]: e3 } });
var dr = class {
  constructor(e3, t3, i3, s3) {
    this.name = e3, this.prefix = t3, this.baseEncode = i3, this.baseDecode = s3, this.encoder = new hr(e3, t3, i3), this.decoder = new lr(e3, t3, s3);
  }
  encode(e3) {
...
var Ee2 = ({ name: r2, prefix: e3, encode: t3, decode: i3 }) => new dr(r2, e3, t3, i3);
var de = ({ prefix: r2, name: e3, alphabet: t3 }) => {
  const { encode: i3, decode: s3 } = or2(t3, e3);
  return Ee2({ prefix: r2, name: e3, encode: i3, decode: (n2) => si2(s3(n2)) });
};
var gr = (r2, e3, t3, i3) => {
  const s3 = {};
  for (let l4 = 0; l4 < e3.length; ++l4) s3[e3[l4]] = l4;
  let n2 = r2.length;
  for (; r2[n2 - 1] === "="; ) --n2;
  const o2 = new Uint8Array(n2 * t3 / 8 | 0);
  let a = 0, c3 = 0, h5 = 0;
  for (let l4 = 0; l4 < n2; ++l4) {
    const d2 = s3[r2[l4]];
    if (d2 === void 0) throw new SyntaxError(`Non-${i3} character`);
    c3 = c3 << t3 | d2, a += t3, a >= 8 && (a -= 8, o2[h5++] = 255 & c3 >> a);
  }
  if (a >= t3 || 255 & c3 << 8 - a) throw new SyntaxError("Unexpected end of data");
  return o2;
};
var pr = (r2, e3, t3) => {
  const i3 = e3[e3.length - 1] === "=", s3 = (1 << t3) - 1;
  let n2 = "", o2 = 0, a = 0;
  for (let c3 = 0; c3 < r2.length; ++c3) for (a = a << 8 | r2[c3], o2 += 8; o2 > t3; ) o2 -= t3, n2 += e3[s3 & a >> o2];
  if (o2 && (n2 += e3[s3 & a << t3 - o2]), i3) for (; n2.length * t3 & 7; ) n2 += "=";
  return n2;
};
var P3 = ({ name: r2, prefix: e3, bitsPerChar: t3, alphabet: i3 }) => Ee2({ prefix: e3, name: r2, encode(s3) {
  return pr(s3, i3, t3);
}, decode(s3) {
  return gr(s3, i3, t3, r2);
} });
...
var ni2 = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var Wr2 = ni2.reduce((r2, e3, t3) => (r2[t3] = e3, r2), []);
var Hr2 = ni2.reduce((r2, e3, t3) => (r2[e3.codePointAt(0)] = t3, r2), []);
function Yr2(r2) {
  return r2.reduce((e3, t3) => (e3 += Wr2[t3], e3), "");
}
function Jr2(r2) {
  const e3 = [];
  for (const t3 of r2) {
    const i3 = Hr2[t3.codePointAt(0)];
    if (i3 === void 0) throw new Error(`Non-base256emoji character: ${t3}`);
    e3.push(i3);
  }
...
function ai(r2, e3, t3) {
  e3 = e3 || [], t3 = t3 || 0;
  for (var i3 = t3; r2 >= sn3; ) e3[t3++] = r2 & 255 | oi, r2 /= 128;
  for (; r2 & tn2; ) e3[t3++] = r2 & 255 | oi, r2 >>>= 7;
  return e3[t3] = r2 | 0, ai.bytes = t3 - i3 + 1, e3;
}
var rn2 = Me;
var nn2 = 128;
var ci = 127;
function Me(r2, i3) {
  var t3 = 0, i3 = i3 || 0, s3 = 0, n2 = i3, o2, a = r2.length;
  do {
    if (n2 >= a) throw Me.bytes = 0, new RangeError("Could not decode varint");
    o2 = r2[n2++], t3 += s3 < 28 ? (o2 & ci) << s3 : (o2 & ci) * Math.pow(2, s3), s3 += 7;
  } while (o2 >= nn2);
  return Me.bytes = n2 - i3, t3;
}
...
var hi = bn;
var li2 = (r2, e3, t3 = 0) => (hi.encode(r2, e3, t3), e3);
var ui = (r2) => hi.encodingLength(r2);
var Ke = (r2, e3) => {
  const t3 = e3.byteLength, i3 = ui(r2), s3 = i3 + ui(t3), n2 = new Uint8Array(s3 + t3);
  return li2(r2, n2, 0), li2(t3, n2, i3), n2.set(e3, s3), new mn(r2, t3, e3, n2);
};
var mn = class {
  constructor(e3, t3, i3, s3) {
    this.code = e3, this.size = t3, this.digest = i3, this.bytes = s3;
  }
};
var di = ({ name: r2, code: e3, encode: t3 }) => new fn2(r2, e3, t3);
var fn2 = class {
  constructor(e3, t3, i3) {
    this.name = e3, this.code = t3, this.encode = i3;
  }
  digest(e3) {
    if (e3 instanceof Uint8Array) {
      const t3 = this.encode(e3);
      return t3 instanceof Uint8Array ? Ke(this.code, t3) : t3.then((i3) => Ke(this.code, i3));
    } else throw Error("Unknown type, must be binary type");
  }
};
var gi2 = (r2) => async (e3) => new Uint8Array(await crypto.subtle.digest(r2, e3));
...
function mi2(r2, e3, t3, i3) {
  return { name: r2, prefix: e3, encoder: { name: r2, prefix: e3, encode: t3 }, decoder: { decode: i3 } };
}
var fi2 = mi2("utf8", "u", (r2) => "u" + new TextDecoder("utf8").decode(r2), (r2) => new TextEncoder().encode(r2.substring(1)));
var Be = mi2("ascii", "a", (r2) => {
  let e3 = "a";
  for (let t3 = 0; t3 < r2.length; t3++) e3 += String.fromCharCode(r2[t3]);
  return e3;
}, (r2) => {
  r2 = r2.substring(1);
  const e3 = Cn(r2.length);
  for (let t3 = 0; t3 < r2.length; t3++) e3[t3] = r2.charCodeAt(t3);
  return e3;
});
...
var controller16 = {
  ...
  async registerName(name) {
    ...
    try {
      ...
      const errorMessage = EnsController.parseEnsApiError(e3, `Error registering name ${name}`);
      RouterController.replace("RegisterAccountName");
      throw new Error(errorMessage);
    } finally {
      state23.loading = false;
...
*/
//# sourceMappingURL=chunk-AQ36ZHFJ.js.map
