...
// node_modules/@base-org/account/node_modules/zustand/esm/middleware.mjs
...
// node_modules/@base-org/account/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/crypto.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/legacy.js
...
var SHA1 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i2 = 0; i2 < 80; i2++) {
      ...
      const T2 = rotl(A, 5) + F + E + K2 + SHA1_W[i2] | 0;
      E = D;
      D = C;
      C = rotl(B2, 30);
      B2 = A;
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/sha3.js
var _0n = BigInt(0);
var _1n = BigInt(1);
var _2n = BigInt(2);
var _7n = BigInt(7);
...
// node_modules/@base-org/account/node_modules/@noble/curves/node_modules/@noble/hashes/esm/crypto.js
var crypto3 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@base-org/account/node_modules/@noble/curves/node_modules/@noble/hashes/esm/utils.js
function isBytes2(a) {
  return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
}
function anumber2(n) {
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/utils.js
var _0n2 = BigInt(0);
var _1n2 = BigInt(1);
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/utils.js
...
var hexes3 = Array.from({ length: 256 }, (_v, i2) => i2.toString(16).padStart(2, "0"));
...
// node_modules/@base-org/account/node_modules/@noble/curves/node_modules/@noble/hashes/esm/_md.js
...
// node_modules/@base-org/account/node_modules/@noble/curves/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@base-org/account/node_modules/@noble/curves/node_modules/@noble/hashes/esm/sha2.js
...
// node_modules/@base-org/account/node_modules/@noble/curves/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/modular.js
var _0n3 = BigInt(0);
var _1n3 = BigInt(1);
var _2n2 = BigInt(2);
var _3n = BigInt(3);
...
function tonelliShanks(P) {
  ...
  return function tonelliSlow(Fp3, n) {
    ...
    while (!Fp3.eql(t, Fp3.ONE)) {
      ...
      const exponent = _1n3 << BigInt(M - i2 - 1);
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/curve.js
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/_shortw_utils.js
function createCurve(curveDef, defHash) {
  const create3 = (hash) => weierstrass({ ...curveDef, hash });
  return { ...create3(defHash), create: create3 };
}

// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/secp256k1.js
var secp256k1_CURVE = {
...
var integerToCharacter = Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((a, i2) => [i2, a.charCodeAt(0)]));
var characterToInteger = {
  ...Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((a, i2) => [a.charCodeAt(0), i2])),
  ["=".charCodeAt(0)]: 0,
  ["-".charCodeAt(0)]: 62,
  ["_".charCodeAt(0)]: 63
};
function fromBytes4(value, options = {}) {
  ...
  for (let i2 = 0, j = 0; j < value.length; i2 += 4, j += 3) {
...
function toBytes6(value) {
  ...
  for (let i2 = 0, j = 0; i2 < base64.length; i2 += 4, j += 3) {
    const x = (characterToInteger[decoded[i2]] << 18) + (characterToInteger[decoded[i2 + 1]] << 12) + (characterToInteger[decoded[i2 + 2]] << 6) + characterToInteger[decoded[i2 + 3]];
    decoded[j] = x >> 16;
    decoded[j + 1] = x >> 8 & 255;
    decoded[j + 2] = x & 255;
  }
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/_blake.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/blake2.js
...
var BLAKE2b = class extends BLAKE2 {
  ...
  compress(msg, offset, isLast) {
    ...
    BBUF.set(B2B_IV, 16);
    let { h: h2, l: l2 } = fromBig(BigInt(this.length));
    BBUF[24] = B2B_IV[8] ^ l2;
    BBUF[25] = B2B_IV[9] ^ h2;
    if (isLast) {
      BBUF[28] = ~BBUF[28];
...
var BLAKE2s = class extends BLAKE2 {
  ...
  compress(msg, offset, isLast) {
    const { h: h2, l: l2 } = fromBig(BigInt(this.length));
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress2(BSIGMA, offset, msg, 10, this.v0, this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, B2S_IV[0], B2S_IV[1], B2S_IV[2], B2S_IV[3], l2 ^ B2S_IV[4], h2 ^ B2S_IV[5], isLast ? ~B2S_IV[6] : B2S_IV[6], B2S_IV[7]);
    this.v0 ^= v0 ^ v8;
    this.v1 ^= v1 ^ v9;
    this.v2 ^= v2 ^ v10;
    this.v3 ^= v3 ^ v11;
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/blake3.js
var B3_Flags = {
  CHUNK_START: 1,
  CHUNK_END: 2,
  PARENT: 4,
...
var B3_SIGMA = (() => {
  const Id = Array.from({ length: 16 }, (_2, i2) => i2);
...
var BLAKE3 = class _BLAKE3 extends BLAKE2 {
  ...
  b2Compress(counter, flags, buf, bufPos = 0) {
    ...
    const { h: h2, l: l2 } = fromBig(BigInt(counter), true);
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress2(B3_SIGMA, bufPos, buf, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], B3_IV[0], B3_IV[1], B3_IV[2], B3_IV[3], h2, l2, pos, flags);
    s[0] = v0 ^ v8;
    s[1] = v1 ^ v9;
    s[2] = v2 ^ v10;
    s[3] = v3 ^ v11;
  ...
  b2CompressOut() {
    ...
    const { h: h2, l: l2 } = fromBig(BigInt(this.chunkOut++));
    swap32IfBE(buffer32);
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress2(B3_SIGMA, 0, buffer32, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], B3_IV[0], B3_IV[1], B3_IV[2], B3_IV[3], l2, h2, pos, flags);
    out32[0] = v0 ^ v8;
    out32[1] = v1 ^ v9;
    out32[2] = v2 ^ v10;
    out32[3] = v3 ^ v11;
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/bls.js
var _0n7 = BigInt(0);
var _1n7 = BigInt(1);
var _2n5 = BigInt(2);
var _3n3 = BigInt(3);
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/abstract/tower.js
var _0n8 = BigInt(0);
var _1n8 = BigInt(1);
var _2n6 = BigInt(2);
var _3n4 = BigInt(3);
...
function psiFrobenius(Fp3, Fp22, base2) {
  const PSI_X = Fp22.pow(base2, (Fp3.ORDER - _1n8) / _3n4);
  const PSI_Y = Fp22.pow(base2, (Fp3.ORDER - _1n8) / _2n6);
  function psi(x, y2) {
    const x2 = Fp22.mul(Fp22.frobeniusMap(x, 1), PSI_X);
    const y22 = Fp22.mul(Fp22.frobeniusMap(y2, 1), PSI_Y);
    return [x2, y22];
  }
  const PSI2_X = Fp22.pow(base2, (Fp3.ORDER ** _2n6 - _1n8) / _3n4);
  const PSI2_Y = Fp22.pow(base2, (Fp3.ORDER ** _2n6 - _1n8) / _2n6);
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/bls12-381.js
var _0n9 = BigInt(0);
var _1n9 = BigInt(1);
var _2n7 = BigInt(2);
var _3n5 = BigInt(3);
...
function pointG2FromBytes(bytes) {
  ...
  const slc = (b2, from9, to) => bytesToNumberBE(b2.slice(from9, to));
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/nist.js
var p256_CURVE = {
...
// node_modules/@base-org/account/node_modules/@noble/curves/esm/p256.js
var p2562 = p256;
var secp256r1 = p256;
  ...
  try {
    ...
    const findStart = (key) => {
      ...
      for (let i2 = 0; i2 < data.length - coordinate.length; i2++)
        if (coordinate.every((byte, j) => data[i2 + j] === byte))
...
*/
//# sourceMappingURL=dist-BU5HFB3H.js.map
