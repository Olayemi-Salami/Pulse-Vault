...
// node_modules/@reown/appkit-ui/node_modules/lit-html/development/directives/if-defined.js
var ifDefined2 = (value) => value ?? nothing;
...
var WuiListWallet = class WuiListWallet2 extends LitElement {
  ...
  render() {
    return html`
      <button ?disabled=${this.disabled} tabindex=${ifDefined2(this.tabIdx)}>
...
var W3mConnectInjectedWidget = class W3mConnectInjectedWidget2 extends LitElement2 {
  ...
  render() {
    ...
    return html2`
      <wui-flex flexDirection="column" gap="xs">
        ${injectedConnectors.map((connector) => html2`
            <wui-list-wallet
              imageSrc=${ifDefined(AssetUtil.getConnectorImage(connector))}
              .installed=${true}
              name=${connector.name ?? "Unknown"}
...
var W3mConnectingWcView = class W3mConnectingWcView2 extends LitElement2 {
  ...
  reownBrandingTemplate() {
    ...
    return html2`<wui-ux-by-reown></wui-ux-by-reown>`;
  }
    ...
    return html`
      <label>
        <input
          ...
          type="checkbox"
          ?checked=${ifDefined2(this.checked)}
  ...
  render() {
    return html`
      <button>
        ...
        <wui-switch ?checked=${ifDefined2(this.checked)}></wui-switch>
      </button>
    `;
  }
};
  ...
  render() {
    ...
    return html`${this.templateIcon()}
      <input
        ...
        type=${this.type}
        enterkeyhint=${ifDefined2(this.enterKeyHint)}
        ?disabled=${this.disabled}
        placeholder=${this.placeholder}
        @input=${this.dispatchInputChangeEvent.bind(this)}
        .value=${this.value || ""}
        tabindex=${ifDefined2(this.tabIdx)}
      />
      <slot></slot>`;
  }
  templateIcon() {
  ...
  render() {
    ...
    return html2`
      ...
      ${isSearch || this.badge ? html2`<w3m-all-wallets-search
          ...
          ></w3m-all-wallets-search>` : html2`<w3m-all-wallets-list badge=${ifDefined(this.badge)}></w3m-all-wallets-list>`}
    `;
  }
  onInputChange(event) {
  ...
  render() {
    return html`
      <button
        ...
        data-iconvariant=${ifDefined2(this.iconVariant)}
        tabindex=${ifDefined2(this.tabIdx)}
      >
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=basic-3KGZHCHS.js.map
