...
var secp256k1 = createCurve2({ ...secp256k1_CURVE, Fp: Fpk1, lowS: true, endo: secp256k1_ENDO }, sha2562);
...
var radix2carry = (from5, to) => from5 + (to - gcd(from5, to));
var powers = (() => {
  let res = [];
  for (let i = 0; i < 40; i++)
    res.push(2 ** i);
...
function convertRadix2(data, from5, to, padding2) {
  ...
  if (radix2carry(from5, to) > 32) {
    throw new Error(`convertRadix2: carry overflow from=${from5} to=${to} carryBits=${radix2carry(from5, to)}`);
  }
  let carry = 0;
  let pos = 0;
...
var sha2563 = createHasher4(() => new SHA2562());
var sha2242 = createHasher4(() => new SHA2242());
var sha5123 = createHasher4(() => new SHA5122());
var sha3843 = createHasher4(() => new SHA3842());
...
*/
//# sourceMappingURL=chunk-UBE6HE2N.js.map
