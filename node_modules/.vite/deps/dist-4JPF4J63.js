...
import {
  ...
  init_preact_module,
  y
} from "./chunk-XHUZQAP3.js";
import "./chunk-UBE6HE2N.js";
import {
  import_index
...
import {
  ...
  readContract,
  waitForCallsStatus
} from "./chunk-MK4IQLMT.js";
import {
  decodeFunctionData,
  encodeFunctionData,
  erc20Abi,
  isAddressEqual
} from "./chunk-XNINWVSI.js";
import "./chunk-WF7KJ4OX.js";
import {
  defineChain
} from "./chunk-WEEVC3DE.js";
import {
  BaseError,
  decodeAbiParameters,
  encodeAbiParameters,
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_assert.js
var require_assert = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_assert.js"(exports) {
    "use strict";
    ...
    var assert7 = { number, bool, bytes: bytes2, hash, exists: exists2, output: output2 };
    exports.default = assert7;
  }
});

// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_u64.js
var require_u64 = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_u64.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var toBig = (h2, l) => BigInt(h2 >>> 0) << _32n3 | BigInt(l >>> 0);
    exports.toBig = toBig;
    var shrSH3 = (h2, _l, s) => h2 >>> s;
    exports.shrSH = shrSH3;
    var shrSL3 = (h2, l, s) => h2 << 32 - s | l >>> s;
    exports.shrSL = shrSL3;
    var rotrSH3 = (h2, l, s) => h2 >>> s | l << 32 - s;
    exports.rotrSH = rotrSH3;
    var rotrSL3 = (h2, l, s) => h2 << 32 - s | l >>> s;
    exports.rotrSL = rotrSL3;
    var rotrBH3 = (h2, l, s) => h2 << 64 - s | l >>> s - 32;
    exports.rotrBH = rotrBH3;
    var rotrBL3 = (h2, l, s) => h2 >>> s - 32 | l << 64 - s;
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/crypto.js
var require_crypto = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/crypto.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/utils.js
var require_utils = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var hexes5 = Array.from({ length: 256 }, (_2, i) => i.toString(16).padStart(2, "0"));
    ...
    function wrapConstructorWithOpts(hashCons) {
      const hashC = (msg, opts) => hashCons(opts).update(toBytes8(msg)).digest();
      const tmp = hashCons({});
      hashC.outputLen = tmp.outputLen;
      hashC.blockLen = tmp.blockLen;
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/sha3.js
var require_sha3 = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/sha3.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    for (let round = 0, R = _1n10, x = 1, y2 = 0; round < 24; round++) {
      [x, y2] = [y2, (2 * x + 3 * y2) % 5];
    ...
    var rotlH2 = (h2, l, s) => s > 32 ? (0, _u64_js_1.rotlBH)(h2, l, s) : (0, _u64_js_1.rotlSH)(h2, l, s);
    var rotlL2 = (h2, l, s) => s > 32 ? (0, _u64_js_1.rotlBL)(h2, l, s) : (0, _u64_js_1.rotlSL)(h2, l, s);
...
var require_util = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/util.cjs"(exports, module) {
    ...
    function bitLengthFromBigInt(num2) {
      return num2.toString(2).length;
    }
    function bufferBEFromBigInt(num2, length) {
    ...
    function keccak(a, bits) {
      ...
      return Buffer.from(keccak_2562(new Uint8Array(a)));
    }
  ...
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/abi.cjs"(exports, module) {
    ...
    function encodeSingle(type, arg) {
      ...
      if (type === "address") {
        ...
        size4 = parseTypeArray(type);
        if (size4 !== "dynamic" && size4 !== 0 && arg.length > size4) {
          throw new Error("Elements exceed array size: " + size4);
        }
        ret = [];
        ...
        size4 = parseTypeN(type);
        if (size4 < 1 || size4 > 32) {
          throw new Error("Invalid bytes<N> width: " + size4);
        }
        return util.setLengthRight(arg, 32);
      } else if (type.startsWith("uint")) {
        size4 = parseTypeN(type);
        if (size4 % 8 || size4 < 8 || size4 > 256) {
          throw new Error("Invalid uint<N> width: " + size4);
        }
        num2 = parseNumber(arg);
        const bitLength = util.bitLengthFromBigInt(num2);
        if (bitLength > size4) {
          throw new Error("Supplied uint exceeds width: " + size4 + " vs " + bitLength);
        }
        if (num2 < 0) {
          throw new Error("Supplied uint is negative");
        }
        return util.bufferBEFromBigInt(num2, 32);
      } else if (type.startsWith("int")) {
        size4 = parseTypeN(type);
        if (size4 % 8 || size4 < 8 || size4 > 256) {
          throw new Error("Invalid int<N> width: " + size4);
        }
        num2 = parseNumber(arg);
        const bitLength = util.bitLengthFromBigInt(num2);
        if (bitLength > size4) {
          throw new Error("Supplied int exceeds width: " + size4 + " vs " + bitLength);
        }
        const twos = util.twosFromBigInt(num2, 256);
        return util.bufferBEFromBigInt(twos, 32);
      } else if (type.startsWith("ufixed")) {
        size4 = parseTypeNxM(type);
        num2 = parseNumber(arg);
        if (num2 < 0) {
          throw new Error("Supplied ufixed is negative");
        }
        return encodeSingle("uint256", num2 * BigInt(2) ** BigInt(size4[1]));
      } else if (type.startsWith("fixed")) {
        size4 = parseTypeNxM(type);
        return encodeSingle("int256", parseNumber(arg) * BigInt(2) ** BigInt(size4[1]));
      }
    ...
    function solidityPack(types, values) {
      ...
      for (var i = 0; i < types.length; i++) {
        ...
        if (type === "bytes") {
          ...
          ret.push(util.setLengthRight(value, size4));
        } else if (type.startsWith("uint")) {
          size4 = parseTypeN(type);
          if (size4 % 8 || size4 < 8 || size4 > 256) {
            throw new Error("Invalid uint<N> width: " + size4);
          }
          num2 = parseNumber(value);
          const bitLength = util.bitLengthFromBigInt(num2);
          if (bitLength > size4) {
            throw new Error("Supplied uint exceeds width: " + size4 + " vs " + bitLength);
          }
          ret.push(util.bufferBEFromBigInt(num2, size4 / 8));
        } else if (type.startsWith("int")) {
          size4 = parseTypeN(type);
          if (size4 % 8 || size4 < 8 || size4 > 256) {
            throw new Error("Invalid int<N> width: " + size4);
          ...
          const twos = util.twosFromBigInt(num2, size4);
          ret.push(util.bufferBEFromBigInt(twos, size4 / 8));
        } else {
          throw new Error("Unsupported or invalid type: " + type);
        }
      }
...
// node_modules/@coinbase/wallet-sdk/node_modules/zustand/esm/middleware.mjs
function createJSONStorage(getStorage, options) {
  ...
  const persistStorage = {
    getItem: (name) => {
      ...
      const str = (_a = storage3.getItem(name)) != null ? _a : null;
...
// node_modules/@coinbase/wallet-sdk/node_modules/zustand/esm/vanilla.mjs
...
function hexStringFromNumber(num2) {
  return HexString(`0x${BigInt(num2).toString(16)}`);
}
...
function ensureIntNumber(num2) {
  if (typeof num2 === "number" && Number.isInteger(num2)) {
    return IntNumber(num2);
  }
  if (typeof num2 === "string") {
    if (INT_STRING_REGEX.test(num2)) {
      return IntNumber(Number(num2));
    }
    if (isHexString(num2)) {
      return IntNumber(Number(BigInt(ensureEvenLengthHexString(num2, true))));
    }
  }
  throw standardErrors.rpc.invalidParams(`Not an integer: ${String(num2)}`);
}
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/crypto.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/legacy.js
...
function ripemd_f(group, x, y2, z) {
  if (group === 0)
    return x ^ y2 ^ z;
  if (group === 1)
    return x & y2 | ~x & z;
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/sha3.js
var _0n = BigInt(0);
var _1n = BigInt(1);
var _2n = BigInt(2);
var _7n = BigInt(7);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/node_modules/@noble/hashes/esm/crypto.js
var crypto3 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/node_modules/@noble/hashes/esm/utils.js
function isBytes2(a) {
  return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
}
function anumber2(n) {
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/utils.js
var _0n2 = BigInt(0);
var _1n2 = BigInt(1);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/utils.js
...
function pad2(bytes2, options = {}) {
  ...
  for (let i = 0; i < size4; i++) {
    ...
    paddedBytes[padEnd ? i : size4 - i - 1] = bytes2[padEnd ? i : bytes2.length - i - 1];
  }
  return paddedBytes;
}
...
function sha2563(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes2 = sha2562(from2(value));
  if (as === "Bytes")
    return bytes2;
  return fromBytes(bytes2);
}

// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/internal/lru.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/Caches.js
var caches = {
...
function toBytes4(publicKey, options = {}) {
  ...
  constructor({ publicKey }) {
    super(`Value \`${publicKey}\` is an invalid public key size.`, {
      metaMessages: [
        ...
        `Received ${size3(from(publicKey))} bytes.`
      ]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/Address.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/internal/abiItem.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/AbiItem.js
function from4(abiItem, options = {}) {
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/internal/cursor.js
var staticCursor = {
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/AbiParameters.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/AbiError.js
function from5(abiError, options = {}) {
  return from4(abiError, options);
}
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/node_modules/@noble/hashes/esm/_md.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/node_modules/@noble/hashes/esm/sha2.js
...
var sha5122 = createHasher2(() => new SHA5122());
var sha3842 = createHasher2(() => new SHA3842());
var sha512_2562 = createHasher2(() => new SHA512_2562());
var sha512_2242 = createHasher2(() => new SHA512_2242());

// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/node_modules/@noble/hashes/esm/hmac.js
var HMAC = class extends Hash2 {
  constructor(hash, _key) {
    ...
    pad4.set(key.length > blockLen ? hash.create().update(key).digest() : key);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/modular.js
var _0n3 = BigInt(0);
var _1n3 = BigInt(1);
var _2n2 = BigInt(2);
var _3n = BigInt(3);
...
function Field(ORDER, bitLenOrOpts, isLE4 = false, opts = {}) {
  ...
  const f = Object.freeze({
    ...
    fromBytes: (bytes2, skipValidation = true) => {
      ...
      let scalar = isLE4 ? bytesToNumberLE(bytes2) : bytesToNumberBE(bytes2);
      if (modFromBytes)
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/curve.js
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
function weierstrassN(params, extraOpts = {}) {
  ...
  function pointFromBytes(bytes2) {
    ...
    if (length === comp && (head === 2 || head === 3)) {
      ...
      const y2 = Fp3.fromBytes(tail.subarray(L, L * 2));
      if (!isValidXY(x, y2))
  ...
  class Point {
    ...
    static fromAffine(p) {
      ...
      if (Fp3.is0(x) && Fp3.is0(y2))
        return Point.ZERO;
      return new Point(x, y2, Fp3.ONE);
    }
...
function mapToCurveSimpleSWU(Fp3, opts) {
  validateField(Fp3);
  const { A, B: B2, Z } = opts;
  if (!Fp3.isValid(A) || !Fp3.isValid(B2) || !Fp3.isValid(Z))
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  class Signature {
    ...
    static fromBytes(bytes2, format2 = defaultSigOpts_format) {
      validateSigLength(bytes2, format2);
      let recid;
      if (format2 === "der") {
        const { r: r3, s: s2 } = DER.toSig(_abytes2(bytes2));
  ...
  function verify4(signature, message, publicKey, opts = {}) {
...
function _weierstrass_new_output_to_legacy(c, Point) {
  ...
  function isWithinCurveOrder(num2) {
    return inRange(num2, _1n5, Fn.ORDER);
  }
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/_shortw_utils.js
function createCurve(curveDef, defHash) {
  const create3 = (hash) => weierstrass({ ...curveDef, hash });
  return { ...create3(defHash), create: create3 };
}

// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/secp256k1.js
var secp256k1_CURVE = {
...
function taggedHash(tag, ...messages) {
  ...
  if (tagP === void 0) {
    const tagH = sha2564(utf8ToBytes2(tag));
...
function lift_x(x) {
  ...
  if (!hasEven(y2))
    y2 = Fp3.neg(y2);
  const p = Pointk1.fromAffine({ x, y: y2 });
  p.assertValidity();
  return p;
}
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    const { x, y: y2 } = R.toAffine();
    if (R.is0() || !hasEven(y2) || x !== r2)
      return false;
    return true;
  } catch (error) {
    return false;
  ...
  constructor({ signature }) {
    super(`Value \`${signature}\` is an invalid signature size.`, {
      metaMessages: [
        ...
        `Received ${size3(from(signature))} bytes.`
      ]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/internal/base58.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/_blake.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/blake2.js
...
var BLAKE2s = class extends BLAKE2 {
  ...
  compress(msg, offset, isLast) {
    ...
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress2(BSIGMA, offset, msg, 10, this.v0, this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, B2S_IV[0], B2S_IV[1], B2S_IV[2], B2S_IV[3], l ^ B2S_IV[4], h2 ^ B2S_IV[5], isLast ? ~B2S_IV[6] : B2S_IV[6], B2S_IV[7]);
    this.v0 ^= v0 ^ v8;
    this.v1 ^= v1 ^ v9;
    this.v2 ^= v2 ^ v10;
    this.v3 ^= v3 ^ v11;
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/blake3.js
var B3_Flags = {
  CHUNK_START: 1,
  CHUNK_END: 2,
  PARENT: 4,
...
var B3_SIGMA = (() => {
  const Id = Array.from({ length: 16 }, (_2, i) => i);
...
var BLAKE3 = class _BLAKE3 extends BLAKE2 {
  ...
  b2Compress(counter, flags, buf, bufPos = 0) {
    ...
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress2(B3_SIGMA, bufPos, buf, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], B3_IV[0], B3_IV[1], B3_IV[2], B3_IV[3], h2, l, pos, flags);
    s[0] = v0 ^ v8;
    s[1] = v1 ^ v9;
    s[2] = v2 ^ v10;
    s[3] = v3 ^ v11;
  ...
  b2CompressOut() {
    ...
    swap32IfBE(buffer32);
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress2(B3_SIGMA, 0, buffer32, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], B3_IV[0], B3_IV[1], B3_IV[2], B3_IV[3], l, h2, pos, flags);
    out32[0] = v0 ^ v8;
    out32[1] = v1 ^ v9;
    out32[2] = v2 ^ v10;
    out32[3] = v3 ^ v11;
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/Blobs.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/bls.js
var _0n7 = BigInt(0);
var _1n7 = BigInt(1);
var _2n5 = BigInt(2);
var _3n3 = BigInt(3);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/abstract/tower.js
var _0n8 = BigInt(0);
var _1n8 = BigInt(1);
var _2n6 = BigInt(2);
var _3n4 = BigInt(3);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/bls12-381.js
var _0n9 = BigInt(0);
var _1n9 = BigInt(1);
var _2n7 = BigInt(2);
var _3n5 = BigInt(3);
...
function pointG1ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    ...
    if (is0) {
      ...
      return concatBytes(numberToBytesBE(x, L), numberToBytesBE(y2, L));
    }
  }
}
...
function pointG1FromBytes(bytes2) {
  ...
  if (value.length === 48 && compressed) {
    ...
    const y2 = bytesToNumberBE(value.subarray(L));
    if (infinity) {
      if (x !== _0n9 || y2 !== _0n9)
...
function pointG2ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    ...
    const flag = Boolean(y2.c1 === _0n9 ? y2.c0 * _2n7 / P : y2.c1 * _2n7 / P);
...
function pointG2FromBytes(bytes2) {
  ...
  if (value.length === 96 && compressed) {
    ...
    const Y_bit = y2.c1 === _0n9 ? y2.c0 * _2n7 / P : y2.c1 * _2n7 / P ? _1n9 : _0n9;
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/RpcResponse.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/Provider.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/nist.js
var p256_CURVE = {
...
var p256 = createCurve({ ...p256_CURVE, Fp: Fp256, lowS: false }, sha2564);
var p256_hasher = (() => {
...
var p384 = createCurve({ ...p384_CURVE, Fp: Fp384, lowS: false }, sha3842);
var p384_hasher = (() => {
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/curves/esm/p256.js
var p2562 = p256;
var secp256r1 = p256;
var hashToCurve2 = (() => p256_hasher.hashToCurve)();
var encodeToCurve2 = (() => p256_hasher.encodeToCurve)();

// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/P256.js
function verify(options) {
  const { hash, payload, publicKey, signature } = options;
  return secp256r1.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex2(publicKey).substring(2), ...hash ? [{ prehash: true, lowS: true }] : []);
}
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/_esm/core/internal/webauthn.js
function parseAsn1Signature(bytes2) {
  const r_start = bytes2[4] === 0 ? 5 : 4;
  const r_end = r_start + 32;
  const s_start = bytes2[r_end + 2] === 0 ? r_end + 3 : r_end + 2;
  const r2 = BigInt(fromBytes(bytes2.slice(r_start, r_end)));
  const s = BigInt(fromBytes(bytes2.slice(s_start)));
  return {
    r: r2,
...
function getClientDataJSON(options) {
  ...
  return JSON.stringify({
    type: "webauthn.get",
    challenge: fromHex5(challenge2, { url: true, pad: false }),
    origin,
    crossOrigin,
    ...extraClientData
  });
...
function getCredentialCreationOptions(options) {
  ...
  return {
    publicKey: {
      ...
      rp,
      user: {
        id: user?.id ?? keccak2562(fromString2(name), { as: "Bytes" }),
        name,
...
function verify2(options) {
  ...
  if (fromBytes(toBytes6(challenge_extracted)) !== challenge2)
    return false;
...
async function sign2(options) {
  ...
  const r2 = toBigInt2(slice3(signature_bytes, 0, 32));
  let s = toBigInt2(slice3(signature_bytes, 32, 64));
...
async function getAccount() {
  ...
  return {
    ...
    async signMessage({ message }) {
      return sign4(hashMessage(message));
    },
    async signTypedData(parameters) {
      return sign4(hashTypedData(parameters));
    },
    type: "webAuthn"
  };
}
...
function createWalletSendCallsRequest({ calls, from: from9, chainId, capabilities }) {
...
async function createSmartAccount(parameters) {
  ...
  return toSmartAccount({
    ...
    async sign(parameters2) {
      ...
      const signature = await sign3({ hash, owner });
      return wrapSignature({
        ownerIndex,
        signature
      });
...
async function sign3({ hash, owner }) {
  if (owner.type === "webAuthn") {
...
function toWebAuthnSignature({ webauthn, signature }) {
  const { r: r2, s } = fromHex3(signature);
    ...
    return new Promise((resolve, reject) => {
      void (async () => {
        ...
        try {
          ...
          resolve(decoder3.decode(decrypted));
        } catch (err) {
          reject(err);
        }
      })();
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/esm/crypto.js
...
var hexes4 = Array.from({ length: 256 }, (_2, i) => i.toString(16).padStart(2, "0"));
...
var sha2565 = wrapConstructor(() => new SHA2563());
var sha2243 = wrapConstructor(() => new SHA2243());
...
var WalletLinkSession = class _WalletLinkSession {
  constructor(storage3, id, secret, linked = false) {
    ...
    this.id = id;
    this.secret = secret;
    this.key = bytesToHex2(sha2565(`${id}, ${secret} WalletLink`));
    this._linked = !!linked;
  }
...
*/
//# sourceMappingURL=dist-4JPF4J63.js.map
