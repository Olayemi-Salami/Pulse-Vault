...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-PNYPHJZS.js");
  const signature_ = (() => {
...
function Ic(t) {
  ...
  function j2(g, w2, b4, I3 = U4) {
    ...
    C5 && (w2 = e.hash(w2));
    const { r: Z2, s: st2 } = D2, W3 = B3(w2), J3 = c3(st2), Be4 = s(W3 * J3), zt3 = s(Z2 * J3), vt2 = a2.BASE.multiplyAndAddUnsafe(z2, Be4, zt3)?.toAffine();
...
var qn = class extends m {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V3(this, "events", new import_events3.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i3, s, n2) => {
      ...
      const a2 = n2?.ttl || je2, c3 = Zc(n2), h4 = n2?.prompt || false, l3 = n2?.tag || 0, d3 = n2?.id || getBigIntRpcId().toString(), g = { topic: i3, message: s, opts: { ttl: a2, relay: c3, prompt: h4, tag: l3, id: d3, attestation: n2?.attestation, tvf: n2?.tvf } }, _ = `Failed to publish payload, please try again. id:${d3} tag:${l3}`;
      try {
        const u3 = new Promise(async (b4) => {
          ...
          const I3 = yi(new Promise((D2, j2) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h4, tag: l3, id: d3, attestation: n2?.attestation, tvf: n2?.tvf }).then(D2).catch((T2) => {
          ...
          try {
            ...
            this.queue.set(d3, Ge2(Ie2({}, g), { attempt: 1 })), this.logger.warn(D2, D2?.message);
          }
        });
        ...
        try {
          const g = await yi(new Promise((_, u3) => {
            this.relayer.request(n2).catch((b4) => {
              this.logger.warn(b4, b4?.message), u3(b4);
            }).then(_);
  ...
  constructor(n2) {
    super(n2), c2(this, "name", dt2), c2(this, "events", new import_events4.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: $2.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c2(this, "requestQueueDelay", import_time3.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      try {
        ...
        throw this.client.logger.error(`approve() -> proposal.get(${e?.id}) failed`), r2.setError(tr2.proposal_not_found), q3;
      }
      try {
      ...
      try {
        g.addTrace(er2.publishing_session_settle), await this.sendRequest({ topic: I3, method: "wc_sessionSettle", params: T2, throwOnFailedPublish: true }).catch((q3) => {
          throw g?.setError(tr2.session_settle_publish_failure), q3;
          ...
          throw g?.setError(tr2.session_approve_publish_failure), q3;
      ...
      return !e || t !== Q.link_mode ? false : ((i3 = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : i3.linkMode) === true && ((o2 = (r2 = this.client.metadata) == null ? void 0 : r2.redirect) == null ? void 0 : o2.universal) !== void 0 && ((l3 = (a2 = this.client.metadata) == null ? void 0 : a2.redirect) == null ? void 0 : l3.universal) !== "" && ((p3 = e?.redirect) == null ? void 0 : p3.universal) !== void 0 && ((h4 = e?.redirect) == null ? void 0 : h4.universal) !== "" && ((u3 = e?.redirect) == null ? void 0 : u3.linkMode) === true && this.client.core.linkModeSupportedApps.includes(e.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
...
var Ie3 = class {
  ...
  async getCapabilities(t) {
    ...
    const w2 = this.client.session.get(t.topic), v4 = ((r2 = w2?.sessionProperties) == null ? void 0 : r2.capabilities) || {};
    if (v4 != null && v4[m2]) return v4?.[m2];
...
var UniversalAdapter = class extends AdapterBlueprint {
  ...
  async getBalance(params) {
    ...
    const balance = balances.find((b4) => b4.chainId === `${params.caipNetwork?.chainNamespace}:${params.chainId}` && b4.symbol === params.caipNetwork?.nativeCurrency.symbol);
    return {
...
var ConfigUtil = {
  ...
  getApiConfig(id, apiProjectConfig) {
    return apiProjectConfig?.find((f6) => f6.id === id);
  },
...
var AppKitBaseClient = class {
  ...
  createAdapters(blueprints) {
    ...
    return this.chainNamespaces.reduce((adapters, namespace) => {
      const blueprint = blueprints?.find((b4) => b4.namespace === namespace);
      if (blueprint) {
        blueprint.construct({
          namespace,
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-3KGZHCHS.js");
      await import("./w3m-modal-LP24PKQZ.js");
...
*/
//# sourceMappingURL=core-KU5QMN73.js.map
