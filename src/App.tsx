...
import { Wallet, Heart, Shield, ArrowDown, Hourglass, Github, Twitter, Linkedin, Globe } from "lucide-react";
import { Button } from "../src/components/ui/button";
import { Link } from 'react-router-dom';

const App: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-teal-400 via-cyan-400 to-purple-500 text-white relative overflow-hidden">
      ...
      <nav className="flex justify-between items-center px-8 py-4">
        ...
        <div className="flex space-x-6 text-sm font-medium items-center">
          ...
          <button className="bg-emerald-500 hover:bg-emerald-600 rounded-full text-sm px-4 py-2">
            Connect Wallet
          </button>
        </div>
      </nav>
      ...
      {/* Hero Section */}
      <main className="flex flex-1 items-center justify-between px-32 relative z-10 mt-16">
        {/* Left Content */}
        <div className="max-w-lg self-center">
          ...
          <p className="mt-6 text-lg text-white/90">
            ...
            <div className="flex space-x-8 mt-8 mb-20">
            ...
            <Link
              to="/dashboard"
              className="bg-white text-gray-900 hover:bg-gray-100 transition-colors px-8 py-3 rounded-full font-semibold flex items-center"
            >
              <Heart className="w-4 h-6 mr-2" />
              Start Your Journey
            </Link>
          </div>
        </div>
      ...
      {/* Features Section */}
      <section id="features" className="relative z-20 py-20 px-8 bg-white text-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {/* Decentralized Data */}
            <div className="group text-center p-6 rounded-2xl shadow-lg bg-gray-50 hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 transition duration-300">
              ...
              <h3 className="text-xl font-semibold mb-3">Decentralized Data</h3>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-purple-500 py-16 px-8">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <button className="bg-white text-gray-900 hover:bg-gray-100 transition-colors px-8 py-3 rounded-full font-semibold flex items-center mx-auto">
      ...
      <footer className="bg-gray-900 text-white py-12 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Decentralized health platform empowering users with AI-driven insights and complete data ownership.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>© 2025 AI Health Coach. All rights reserved. Built with <Heart className="w-4 h-4 inline text-red-500" /> for decentralized health.</p>
          </div>
        </div>
      </footer>
      ...
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-purple-400/30 rounded-full blur-3xl"></div>
      <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-teal-300/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
